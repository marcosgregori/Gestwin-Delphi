object CxTraForm: TCxTraForm
  Left = 662
  Top = 178
  HelpType = htKeyword
  HelpKeyword = 'consultas'
  BorderStyle = bsDialog
  Caption = 'Consulta de transportistas'
  ClientHeight = 375
  ClientWidth = 353
  Color = clBtnFace
  DoubleBuffered = True
  ...
  object Grid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewMatricula: TcxGridDBColumn
        DataBinding.FieldName = 'Matricula'
        Visible = False
        Width = 130
      end
      object TableViewSemiremolque: TcxGridDBColumn
        DataBinding.FieldName = 'Semiremolque'
        Visible = False
        Width = 130
      end
    end
  ...
  object Query: TnxeQuery
    ...
    Timeout = 180000
    SQL.Strings = (
      'SELECT Codigo, Nombre, Telefono, Matricula, Semiremolque'
      'FROM   Transportista'
      'ORDER BY Codigo')
    Left = 212
    Top = 78
    ...
    object QueryMatricula: TWideStringField
      FieldName = 'Matricula'
    end
    object QuerySemiremolque: TWideStringField
      FieldName = 'Semiremolque'
    end
  end
