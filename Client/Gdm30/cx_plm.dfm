object cxPlmForm: TcxPlmForm
  Left = 662
  Top = 178
  HelpType = htKeyword
  HelpKeyword = 'consultas'
  BorderStyle = bsDialog
  Caption = 'Selecci'#243'n de plantilla de lista de materiales'
  ClientHeight = 206
  ClientWidth = 509
  Color = clBtnFace
  DoubleBuffered = True
  ...
  object Query: TnxeQuery
    ...
    SQL.Strings = (
        ...
        'FROM   ListaMateriales LEFT JOIN Articulo ON ( CodigoArticulo=Ar' +
        'ticulo.Codigo )'
      'WHERE NroLinea=0 '
  ...
  object ArticuloTable: TnxeTable
    ...
    object ArticuloTableEsListaMateriales: TBooleanField
      FieldName = 'EsListaMateriales'
    end
  end
