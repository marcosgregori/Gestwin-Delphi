...
// WSDL     : F:\Desktop\Source\Documentacion\Verifactu\2025.06.22\SistemaFacturacion.wsdl
//  >Import : F:\Desktop\Source\Documentacion\Verifactu\2025.06.22\SistemaFacturacion.wsdl>0
//  >Import : F:\Desktop\Source\Documentacion\Verifactu\2025.06.22\SuministroInformacion.xsd
//  >Import : http://www.w3.org/TR/xmldsig-core/xmldsig-core-schema.xsd
//  >Import : F:\Desktop\Source\Documentacion\Verifactu\2025.06.22\SuministroLR.xsd
//  >Import : F:\Desktop\Source\Documentacion\Verifactu\2025.06.22\ConsultaLR.xsd
//  >Import : F:\Desktop\Source\Documentacion\Verifactu\2025.06.22\RespuestaConsultaLR.xsd
//  >Import : F:\Desktop\Source\Documentacion\Verifactu\2025.06.22\RespuestaSuministro.xsd
// Encoding : UTF-8
// Version  : 1.0
// (22/06/2025 17:04:27 - - $Rev: 121536 $)
// ************************************************************************ //
...
type
  ...
  RegFactuSistemaFacturacionType = class;           { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroLR.xsd"[Lit][GblElm] }
  ...
  Encadenamiento2Type      = class;                 { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd"[Cplx] }
  Encadenamiento3Type      = class;                 { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd"[Cplx] }
  ...
  RegistroAltaType         = class;                 { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd"[GblElm] }
  ...
  RegistroAnulacionType    = class;                 { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd"[GblElm] }
  ...
  // Info      : Wrapper
  // ************************************************************************ //
  RegFactuSistemaFacturacionType = class(TRemotable)
  private
  ...
  private
    FRegistroAlta: RegistroAltaType;
    FRegistroAlta_Specified: boolean;
    FRegistroAnulacion: RegistroAnulacionType;
    FRegistroAnulacion_Specified: boolean;
    procedure SetRegistroAlta(Index: Integer; const ARegistroAlta: RegistroAltaType);
    function  RegistroAlta_Specified(Index: Integer): boolean;
    procedure SetRegistroAnulacion(Index: Integer; const ARegistroAnulacion: RegistroAnulacionType);
    function  RegistroAnulacion_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    property RegistroAlta:      RegistroAltaType       Index (IS_OPTN or IS_REF) read FRegistroAlta write SetRegistroAlta stored RegistroAlta_Specified;
    property RegistroAnulacion: RegistroAnulacionType  Index (IS_OPTN or IS_REF) read FRegistroAnulacion write SetRegistroAnulacion stored RegistroAnulacion_Specified;
  end;
  ...
  // Namespace : https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd
  // ************************************************************************ //
  Encadenamiento2Type = class(TRemotable)
  private
    FPrimerRegistro: PrimerRegistroCadenaType;
    FPrimerRegistro_Specified: boolean;
    FRegistroAnterior: EncadenamientoFacturaAnteriorType;
  ...
  // Namespace : https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd
  // ************************************************************************ //
  Encadenamiento3Type = class(TRemotable)
  private
    FPrimerRegistro: PrimerRegistroCadenaType;
    FPrimerRegistro_Specified: boolean;
    FRegistroAnterior: EncadenamientoFacturaAnteriorType;
  ...
  private
    ...
    FEncadenamiento: Encadenamiento3Type;
  ...
  published
    ...
    property Encadenamiento:                      Encadenamiento3Type          read FEncadenamiento write FEncadenamiento;
  ...
  // Namespace : https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd
  // ************************************************************************ //
  RegistroAltaType = class(RegistroFacturacionAltaType)
  private
  published
  end;
  ...
  private
    ...
    FGenerador: PersonaFisicaJuridicaType;
    FGenerador_Specified: boolean;
    FEncadenamiento: Encadenamiento2Type;
    FSistemaInformatico: SistemaInformaticoType;
    FFechaHoraHusoGenRegistro: TXSDateTime;
    FTipoHuella: TipoHuellaType;
    FHuella: TextMax64Type;
  ...
  published
    ...
    property GeneradoPor:              GeneradoPorType             Index (IS_OPTN) read FGeneradoPor write SetGeneradoPor stored GeneradoPor_Specified;
    property Generador:                PersonaFisicaJuridicaType   Index (IS_OPTN) read FGenerador write SetGenerador stored Generador_Specified;
    property Encadenamiento:           Encadenamiento2Type         read FEncadenamiento write FEncadenamiento;
    property SistemaInformatico:       SistemaInformaticoType      read FSistemaInformatico write FSistemaInformatico;
    property FechaHoraHusoGenRegistro: TXSDateTime                 read FFechaHoraHusoGenRegistro write FFechaHoraHusoGenRegistro;
    property TipoHuella:               TipoHuellaType              read FTipoHuella write FTipoHuella;
    property Huella:                   TextMax64Type               read FHuella write FHuella;
  ...
  // Namespace : https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd
  // ************************************************************************ //
  RegistroAnulacionType = class(RegistroFacturacionAnulacionType)
  private
  published
  end;
  ...
  ['{A406673A-FDB9-1549-CE5B-A81BEC1E74C7}']
    function  RegFactuSistemaFacturacion(const RegFactuSistemaFacturacion: RegFactuSistemaFacturacionType): RespuestaRegFactuSistemaFacturacion; stdcall;
...
const
  defWSDL = 'F:\Desktop\Source\Documentacion\Verifactu\2025.06.22\SistemaFacturacion.wsdl';
...
constructor RegFactuSistemaFacturacionType.Create;
begin
  inherited Create;
  FSerializationOptions := [xoLiteralParam];
end;

destructor RegFactuSistemaFacturacionType.Destroy;
begin
...
procedure RegistroFacturaType.SetRegistroAlta(Index: Integer; const ARegistroAlta: RegistroAltaType);
begin
...
procedure RegistroFacturaType.SetRegistroAnulacion(Index: Integer; const ARegistroAnulacion: RegistroAnulacionType);
begin
...
destructor Encadenamiento2Type.Destroy;
begin
  System.SysUtils.FreeAndNil(FRegistroAnterior);
  inherited Destroy;
end;

procedure Encadenamiento2Type.SetPrimerRegistro(Index: Integer; const APrimerRegistroCadenaType: PrimerRegistroCadenaType);
begin
  FPrimerRegistro := APrimerRegistroCadenaType;
  FPrimerRegistro_Specified := True;
end;

function Encadenamiento2Type.PrimerRegistro_Specified(Index: Integer): boolean;
begin
  Result := FPrimerRegistro_Specified;
end;

procedure Encadenamiento2Type.SetRegistroAnterior(Index: Integer; const AEncadenamientoFacturaAnteriorType: EncadenamientoFacturaAnteriorType);
begin
  FRegistroAnterior := AEncadenamientoFacturaAnteriorType;
  FRegistroAnterior_Specified := True;
end;

function Encadenamiento2Type.RegistroAnterior_Specified(Index: Integer): boolean;
begin
  Result := FRegistroAnterior_Specified;
end;

destructor Encadenamiento3Type.Destroy;
begin
  System.SysUtils.FreeAndNil(FRegistroAnterior);
  inherited Destroy;
end;

procedure Encadenamiento3Type.SetPrimerRegistro(Index: Integer; const APrimerRegistroCadenaType: PrimerRegistroCadenaType);
begin
  FPrimerRegistro := APrimerRegistroCadenaType;
  FPrimerRegistro_Specified := True;
end;

function Encadenamiento3Type.PrimerRegistro_Specified(Index: Integer): boolean;
begin
  Result := FPrimerRegistro_Specified;
end;

procedure Encadenamiento3Type.SetRegistroAnterior(Index: Integer; const AEncadenamientoFacturaAnteriorType: EncadenamientoFacturaAnteriorType);
begin
  FRegistroAnterior := AEncadenamientoFacturaAnteriorType;
  FRegistroAnterior_Specified := True;
end;

function Encadenamiento3Type.RegistroAnterior_Specified(Index: Integer): boolean;
begin
  Result := FRegistroAnterior_Specified;
end;
...
initialization
  ...
  RemClassRegistry.RegisterXSClass(RegFactuSistemaFacturacionType, 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroLR.xsd', 'RegFactuSistemaFacturacion');
  RemClassRegistry.RegisterSerializeOptions(RegFactuSistemaFacturacionType, [xoLiteralParam]);
  ...
  RemClassRegistry.RegisterXSClass(Encadenamiento2Type, 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd', 'Encadenamiento2', 'Encadenamiento');
  RemClassRegistry.RegisterXSClass(Encadenamiento3Type, 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd', 'Encadenamiento3', 'Encadenamiento');
  ...
  RemClassRegistry.RegisterXSClass(RegistroAltaType, 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd', 'RegistroAlta');
  ...
  RemClassRegistry.RegisterXSClass(RegistroAnulacionType, 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd', 'RegistroAnulacion');
