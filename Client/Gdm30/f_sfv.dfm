object SfvFrame: TSfvFrame
  ...
  object Grid: TcxGrid
    ...
    object GridView: TcxGridDBTableView
      ...
      object GridViewNroFactura: TcxGridDBColumn
        ...
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.Required = True
        Properties.OnQueryRequest = GridViewNroFacturaPropertiesQueryRequest
        Properties.OnValuePosted = GridViewNroFacturaPropertiesValuePosted
        Properties.MaxLength = 8
        Properties.ValidationOptions = [evoRaiseException, evoAllowLoseFocus]
        Properties.OnValidate = GridViewNroFacturaPropertiesValidate
        Width = 65
      end
  ...
  object FrmFacturaVentasTable: TnxeTable
    ActiveRuntime = True
  ...
  object RelacionDocumentosTable: TnxeTable
    ...
    object RelacionDocumentosTableNroFactura: TIntegerField
    ...
    SQLItems = <
      item
        ...
        SQLText = 
          ...
          '                            '#13#10'Serie NVARCHAR( 20 ),'#13#10'NroFactura ' +
          'INTEGER,'#13#10'Fecha DATE,'#13#10'Propietario NVARCHAR( 5 ),               ' +
          '                   '#13#10'Nombre NVARCHAR( 60 ),   '#13#10'DescripcionMovim' +
          'iento NVARCHAR( 30 ) );'#13#10#13#10'CREATE UNIQUE INDEX Index0 ON <Nombre' +
          'Tabla>( NroRegistro );'#13#10'CREATE INDEX Index1 ON <NombreTabla>( Ej' +
          'ercicio, Serie, NroFactura );  '#13#10
      end>
    Left = 438
    Top = 94
  end
