object MntTctForm: TMntTctForm
  Left = 425
  Top = 231
  HelpType = htKeyword
  HelpKeyword = 'a_tcv'
  BorderStyle = bsDialog
  Caption = 'Tarifas de venta por c'#243'digo de tarifa y clase de art'#237'culo'
  ClientHeight = 398
  ClientWidth = 561
  Color = clBtnFace
  DoubleBuffered = True
  ...
  object KeyPanel: TgxEditPanel
    ...
    object CodigoClaseACtrl: TcxDBTextEdit
      ...
      Properties.OnChange = KeyCtrlPropertiesChange
    ...
    object CodigoTarifaCtrl: TcxDBTextEdit
      ...
      DataBinding.DataSource = DataSource
      Properties.Required = True
      Properties.OnEnter = CodigoTarifaCtrlPropertiesEnter
      Properties.OnExit = CodigoTarifaCtrlPropertiesExit
    ...
    object CopiarButton: TgBitBtn
      Left = 145
      Top = 6
      Width = 73
      Height = 22
      Hint = 'Copia el contenido de una tarifa existente sobre la actual.'
      Caption = 'Co&piar'
      Enabled = False
  ...
  object Data: TgxMemData
    ...
    Left = 456
    Top = 6
    object DataCodigoTarifa: TWideStringField
      DisplayWidth = 2
  ...
  object TarifaClaseAuxTable: TnxeTable
    ActiveRuntime = True
    Database = EnterpriseDataModule.UserDatabase
    Timeout = 6000
    TableName = 'TarifaClase'
