object CxMaqForm: TCxMaqForm
  ...
  object Grid: TcxGrid
    ...
    object TableView: TcxGridDBTableView
      ...
      object TableViewCodigoMaquinaTipo: TcxGridDBColumn
        Caption = 'Tipo'
        DataBinding.FieldName = 'CodigoMaquinaTipo'
        Width = 45
      end
    end
  ...
  object Query: TnxeQuery
    ...
    Timeout = 180000
    SQL.Strings = (
      'SELECT Codigo, Descripcion, CodigoMaquinaTipo'
      'FROM   Maquina'
    ...
    object QueryCodigoMaquinaTipo: TWideStringField
