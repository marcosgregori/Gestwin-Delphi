...
begin
  ...
  TypeCB.ItemHeight := Round(17 * aNewPPI / frx_DefaultPPI); //..
  TypeCB.Height := Round(23 * aNewPPI / frx_DefaultPPI); //..
  ...
  ValueE.Height := Round(21 * aNewPPI / frx_DefaultPPI); //..
...
procedure TfrxParamsEditorForm.OkButtonClick(Sender: TObject);
begin
  {$IFDEF FPC}
