...
uses
  ...
  cxLabel, cxGroupBox, cxPC, dxUIAClasses
{$IFDEF DELPHI16}
, System.UITypes
{$ENDIF}
;
...
type
  TfrxHTMLExportDialog = class(TfrxBaseExportDialog)
    StylesCB: TcxCheckBox;
    PicsSameCB: TcxCheckBox;
    FixWidthCB: TcxCheckBox;
    NavigatorCB: TcxCheckBox;
    MultipageCB: TcxCheckBox;
    BackgrCB: TcxCheckBox;
    OutlineCB: TcxCheckBox;
    PFormatCB: TcxComboBox;
    PicturesL: TcxLabel;
...
begin
  {$IFNDEF FPC}
  PFormatCB.Properties.Items.Add('GIF');
  PFormatCB.Properties.Items.Add('EMF');
  PFormatCB.Properties.Items.Add('WMF');
  {$ENDIF}
  inherited;
end;
