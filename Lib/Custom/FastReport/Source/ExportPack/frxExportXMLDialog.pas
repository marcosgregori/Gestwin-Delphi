...
{$ENDIF}
  ...
  cxRadioGroup, cxLabel, cxCheckBox, cxMaskEdit, cxDropDownEdit, cxButtons,
  cxGroupBox, cxPC, dxUIAClasses
{$IFDEF DELPHI16}
, System.UITypes
{$ENDIF}
;
...
type
  TfrxXMLExportDialog = class(TfrxBaseExportDialog)
    ...
    SplitToSheetGB: TcxGroupBox;
    ContinuousCB: TcxCheckBox;
    RPagesRB: TcxRadioButton;
    PrintOnPrevRB: TcxRadioButton;
    RowsCountRB: TcxRadioButton;
    NotSplitRB: TcxRadioButton;
    ERows: TcxTextEdit;
