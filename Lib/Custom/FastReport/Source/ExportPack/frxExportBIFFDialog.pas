...
uses
  ...
  ComCtrls,
  Controls,
  frxExportBaseDialog, dxBarBuiltInMenu, cxGraphics, cxControls,
  cxLookAndFeels, cxLookAndFeelPainters, cxContainer, cxEdit, Vcl.Menus,
  cxTextEdit, cxRadioGroup, cxLabel, cxCheckBox, cxMaskEdit,
  cxDropDownEdit, cxButtons, cxGroupBox, cxPC, dxUIAClasses
{$IFDEF DELPHI16}
, System.UITypes
{$ENDIF}
;
...
type
  TfrxBIFFExportDialog = class(TfrxBaseExportDialog)
    ...
    rbOriginal: TcxRadioButton;
    rbSingle: TcxRadioButton;
    rbChunks: TcxRadioButton;
    edChunk: TcxTextEdit;
  protected
