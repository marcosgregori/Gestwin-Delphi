...
uses
  ...
  ExtCtrls, StdCtrls, frxClass, frxBaseForm, cxGraphics, cxControls,
  cxLookAndFeels, cxLookAndFeelPainters, cxContainer, cxEdit, Vcl.Menus,
  cxButtons, cxGroupBox, cxTextEdit, cxMaskEdit, cxDropDownEdit, cxLabel,
  cxRadioGroup
  {$IFDEF FPC}
  , LResources, LCLType
  {$ENDIF}
...
type
  ...
  TfrxPageSettingsForm = class(TfrxBaseForm)
    ...
    WidthE: TcxTextEdit;
    HeightE: TcxTextEdit;
    OrientationL: TcxGroupBox;
    PortraitImg: TImage;
    LandscapeImg: TImage;
    MarginsL: TcxGroupBox;
    MarginLeftE: TcxTextEdit;
    MarginTopE: TcxTextEdit;
    MarginRightE: TcxTextEdit;
    MarginBottomE: TcxTextEdit;
    OtherL: TcxGroupBox;
    ...
    UnitL6: TcxLabel;
    SizeCB: TcxComboBox;
    PortraitRB: TcxRadioButton;
    LandscapeRB: TcxRadioButton;
    ApplyToCurRB: TcxRadioButton;
    ApplyToAllRB: TcxRadioButton;
...
begin
  ...
  UnitL5.Caption := uStr;
  UnitL6.Caption := uStr;
  SizeCB.Properties.Items := frxPrinters.Printer.Papers;  //..
