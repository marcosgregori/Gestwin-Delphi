...
function frxConfirmMsg(const Text: String; Buttons: Integer = 0): Integer;  //..
...
procedure frxErrorMsg(const Text: String);
begin
     ShowNotification( ntError, frxResources.Get('mbError'), Text ); //..
     {
...
function frxConfirmMsg(const Text: String; Buttons: Integer = 0 ): Integer;
begin
     Result := ShowNotification( ntQuestion, frxResources.Get('mbConfirm'), Text ); //..
  {
...
procedure frxInfoMsg(const Text: String);
begin
     ShowNotification( ntInformation, frxResources.Get('mbInfo'), Text ); //..
  {
