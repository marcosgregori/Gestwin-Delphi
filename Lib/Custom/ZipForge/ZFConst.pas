...
resourcestring
  SConfirmOverwrite = 'Sustituir el fichero "%s" por "%s"';
  SPasswordTitle = 'Palabra de paso para "%s"';
  SPasswordPrompt = 'Introduzca la palabra de paso: ';
  SOnRequestBlankDisk = 'Por favor, inserte un disco vacío #%d';
  SOnRequestFirstDisk = 'Por favor, inserte el primer disco';
  SOnRequestLastDisk = 'Por favor, inserte el último disco';
  SOnRequestMiddleDisk = 'Por favor, inserte el disco #%d';
  SOnDiskFull =
...
const
  ...
  ZFErrorMessages: array[0..ZFMaxError] of string =
    ...
    'No puedo crear el fichero de salida. Probablemente está siendo bloqueado por otro proceso. Fichero = ''%s''.',
    'El archivo está abierto. Debe cerrase antes de realizar esta operación.',
    'Incapaz de crear el directorio',
    ...
    'El archivo esta dañado. No puede abrirse',
