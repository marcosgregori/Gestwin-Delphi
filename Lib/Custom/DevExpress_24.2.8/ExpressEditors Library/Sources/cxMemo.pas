...
uses
  System.Variants, Vcl.Clipbrd, System.Math, System.UITypes, dxCoreGraphics, cxEditConsts, cxEditUtils, cxScrollBar, dxDPIAwareUtils,
  dxMessages, dxThreading, dxPopupMenus;
...
begin
  Result := (not Assigned(Container)) or Container.NeedAccessibilityHelper;
end;
...
begin
  ...
  if Message.Msg = WM_UAHMEASUREMENUITEM then
