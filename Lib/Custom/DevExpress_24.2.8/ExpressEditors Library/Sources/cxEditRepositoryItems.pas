...
uses
  Winapi.Windows, Winapi.Messages, Vcl.ComCtrls, System.Classes, System.SysUtils, Vcl.Graphics, Vcl.Controls, Vcl.StdCtrls,
  Vcl.Forms, cxClasses, cxEdit, cxTextEdit, cxButtonEdit, cxDropDownEdit, cxImage,
  cxMaskEdit, cxCalendar, cxCurrencyEdit, cxIntegerEdit, cxSpinEdit, cxMemo, cxIndexedComboBox, cxDisplayButtonEdit, cxImageComboBox, //..
  ...
  dxBarCode, dxTokenEdit, dxFormattedLabel;
...
type
  ...
  { TcxEditRepositoryIntegerItem } //..

  TcxEditRepositoryIntegerItem = class(TcxEditRepositoryItem)
  private
  ...
  public
    class function GetEditPropertiesClass: TcxCustomEditPropertiesClass; override;
  published
    property Properties: TcxIntegerEditProperties read GetProperties write SetProperties;
  end;

  { TcxEditRepositoryIndexedComboboxItem } //..

  TcxEditRepositoryIndexedComboBoxItem = class(TcxEditRepositoryItem)
  private
  ...
  { TcxEditRepositoryDisplayButtonEditItem } //..

  TcxEditRepositoryDisplayButtonEditItem = class(TcxEditRepositoryItem)
  private
  ...
  TcxEditRepositoryFormattedLabel = class(TcxEditRepositoryItem)
  private
...
const
  dxThisUnitName = 'cxEditRepositoryItems';
...
class function TcxEditRepositoryIntegerItem.GetEditPropertiesClass: TcxCustomEditPropertiesClass;
begin
  Result := TcxIntegerEditProperties;
end;

function TcxEditRepositoryIntegerItem.GetProperties: TcxIntegerEditProperties;
begin
  Result := inherited Properties as TcxIntegerEditProperties;
end;

procedure TcxEditRepositoryIntegerItem.SetProperties(Value: TcxIntegerEditProperties);
begin
  inherited Properties := Value;
end;
...
class function TcxEditRepositoryIndexedComboBoxItem.GetEditPropertiesClass: TcxCustomEditPropertiesClass;
begin
  Result := TcxIndexedComboBoxProperties;
end;

function TcxEditRepositoryIndexedComboBoxItem.GetProperties: TcxIndexedComboBoxProperties;
begin
  Result := inherited Properties as TcxIndexedComboBoxProperties;
end;

procedure TcxEditRepositoryIndexedComboBoxItem.SetProperties(Value: TcxIndexedComboBoxProperties);
begin
  inherited Properties := Value;
end;
...
class function TcxEditRepositoryDisplayButtonEditItem.GetEditPropertiesClass: TcxCustomEditPropertiesClass;
begin
  Result := TcxDisplayButtonEditProperties;
end;

function TcxEditRepositoryDisplayButtonEditItem.GetProperties: TcxDisplayButtonEditProperties;
begin
  Result := inherited Properties as TcxDisplayButtonEditProperties;
end;

procedure TcxEditRepositoryDisplayButtonEditItem.SetProperties(Value: TcxDisplayButtonEditProperties);
begin
  inherited Properties := Value;
end;
...
class function TcxEditRepositoryFormattedLabel.GetEditPropertiesClass: TcxCustomEditPropertiesClass;
begin
  Result := TdxFormattedLabelProperties;
end;

function TcxEditRepositoryFormattedLabel.GetProperties: TdxFormattedLabelProperties;
begin
  Result := inherited Properties as TdxFormattedLabelProperties;
end;

procedure TcxEditRepositoryFormattedLabel.SetProperties(Value: TdxFormattedLabelProperties);
begin
  inherited Properties := Value;
end;
...
initialization
  ...
  RegisterClasses([TcxEditRepositoryItem, TcxEditRepositoryTextItem,
    ...
    TcxEditRepositoryTokenItem, TcxEditRepositoryFormattedLabel]);
