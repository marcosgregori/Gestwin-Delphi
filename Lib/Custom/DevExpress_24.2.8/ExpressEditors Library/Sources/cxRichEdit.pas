...
uses
  System.Variants, Winapi.Windows, Winapi.Messages, Winapi.ActiveX, Winapi.OleDlg, Vcl.OleConst, Vcl.OleCtnrs, System.Classes, Vcl.Clipbrd, Vcl.ComCtrls, Vcl.Controls, Vcl.Dialogs,
  Vcl.Forms, Vcl.Graphics, Vcl.Menus, Winapi.RichEdit, Vcl.StdCtrls, System.SysUtils,
  ...
  dxDrawRichTextUtils, cxGeometry, dxDPIAwareUtils, cxAccessibility;
...
var
  APopupMenu: TPopupMenu absolute Result;
begin
  if FEditPopupMenu = nil then
  begin
    Result := TPopupMenu.Create(Self);
    APopupMenu.Items.Add(NewItem(cxGetResourceString(@cxSEditRichEditUndoCaption), -1));
    APopupMenu.Items.Add(NewItem(cxGetResourceString(@cxSEditRichEditRedoCaption), -2));
    APopupMenu.Items.Add(NewItem('-', MaxInt));
    APopupMenu.Items.Add(NewItem(cxGetResourceString(@cxSEditRichEditCutCaption), -3));
    APopupMenu.Items.Add(NewItem(cxGetResourceString(@cxSEditRichEditCopyCaption), -4));
    APopupMenu.Items.Add(NewItem(cxGetResourceString(@cxSEditRichEditPasteCaption), -5));
    APopupMenu.Items.Add(NewItem(cxGetResourceString(@cxSEditRichEditDeleteCaption), -6));
    APopupMenu.Items.Add(NewItem('-', MaxInt));
    APopupMenu.Items.Add(NewItem(cxGetResourceString(@cxSEditRichEditSelectAllCaption), -7));

    FEditPopupMenu := Result;
  end
  else
