...
type
  ...
  protected
    ...
    // UI Automation
    function CreateUIAProvider: IdxUIAProvider;
  ...
  public
    ParentBackgroundProvider: TObject;
    BorderExtent: TRect;
    ...
    function GetUnscaledPadding(AUsePainterPadding: Boolean): TdxPadding; virtual; // for internal use //#lcm: WXI
    function SupportsBorders: Boolean; virtual; // for internal use //#lcm: WXI
    function SupportsPadding: Boolean; virtual; // for internal use //#lcm: WXI
  ...
  protected
    ...
    //
    procedure AdjustClientExtentByPadding(var AClientExtent: TRect; ACanvas: TcxCanvas; AViewInfo: TcxCustomEditViewInfo);
  ...
  public
    ...
    function IsPaddingAllowedForInplace: Boolean; virtual;
    function IsPaddingAllowedForStandalone: Boolean; virtual;
...
//    property GradientButtons;
  ...
  protected
    ...
    // UI Automation
    function GetInnerEditUIAProvider: IdxUIAProvider; virtual;
...
begin
  Result := dxUIAGetProvider(FUIAProvider, CreateUIAProvider, SupportsUIAutomation, AIsWMGetObjectCall);
end;
...
function TcxCustomEditViewInfo.GetUnscaledPadding(AUsePainterPadding: Boolean): TdxPadding;
begin
...
function TcxCustomEditViewInfo.SupportsPadding: Boolean;
begin
...
begin
  ...
  AdjustClientExtentByPadding(Result, ACanvas, AViewInfo);
end;

procedure TcxCustomEditViewData.AdjustClientExtentByPadding(var AClientExtent: TRect; ACanvas: TcxCanvas; AViewInfo: TcxCustomEditViewInfo);
  ...
  procedure ApplyPadding(AUsePainterPadding: Boolean);
  var
    AActualPadding: TdxPadding;
  begin
    AActualPadding := AViewInfo.GetUnscaledPadding(AUsePainterPadding);
    AdjustPaddingForButtons(AActualPadding);
    AdjustPadding(AActualPadding);
    AActualPadding.InflatePadding(AClientExtent, ScaleFactor, UseRightToLeftScrollBar);
  end;

begin
  if AViewInfo.SupportsPadding then
  begin
    if (IsInplace and IsPaddingAllowedForInplace) or IsPaddingAllowedForStandalone then
      ApplyPadding(True);
  end
  else
  begin
    if (IsInplace and IsPaddingAllowedForInplace) or
      (TdxVisualRefinements.UsePaddingForStandaloneEditors and IsPaddingAllowedForStandalone) then
      ApplyPadding(False);
  end;
end;
...
function TcxCustomEditViewData.IsPaddingAllowedForInplace: Boolean;
begin
  Result := True;
end;

function TcxCustomEditViewData.IsPaddingAllowedForStandalone: Boolean;
begin
  Result := True;
end;
...
function TcxCustomEdit.GetInnerEditUIAProvider: IdxUIAProvider;
begin
  Result := nil;
end;
