...
{           ExpressPDFViewer                                         }
{                                                                    }
{           Copyright (c) 2015-2025 Developer Express Inc.           }
{           ALL RIGHTS RESERVED                                      }
{                                                                    }
...
uses
  Winapi.Windows, System.Classes, System.SysUtils, System.Types, System.Generics.Defaults, System.Generics.Collections, dxCore, dxCoreClasses, cxGeometry,
...
type
  ...
  TdxFontFileCMapGlyphRangeList = class(TList<TdxFontFileCMapGlyphRange>)
  public
    constructor Create;
  end;
  ...
  TdxFontFileCMapRowList = class(TList<TdxFontFileCMapRow>)
  public
    constructor Create;
  end;
  ...
  TdxFontFileSubsetGlyphList = class(TList<TdxFontFileSubsetGlyph>)
  public
    constructor Create;
  end;
  ...
  strict private
    ...
    FGlyphIdArray: TSmallIntDynArray;
    FGlyphRanges: TdxFontFileCMapGlyphRangeList;
  ...
  public
    ...
    function GetGlyphRanges: TdxFontFileCMapGlyphRangeList;
    function Validate: Boolean;

    property EndCode: TSmallIntDynArray read FEndCode;
    property GlyphIdArray: TSmallIntDynArray read FGlyphIdArray;
    property GlyphRanges: TdxFontFileCMapGlyphRangeList read GetGlyphRanges;
  ...
  strict private
    ...
    FVersion: SmallInt;
    function TryCreateRecord(APlatformId: TdxFontFilePlatformID; AEncodingId: TdxFontFileEncodingID;
      AFormat: TdxFontFileCMapFormatID; AStream: TdxFontFileStream; out ARecord: TdxFontFileCMapCustomFormatRecord): Boolean;
  ...
  TdxFontFileNameRecordList = class(TList<TdxFontFileNameRecord>)
  public
    constructor Create;
  end;
  ...
  strict private
    ...
    FNamingTable: TdxFontFileNameRecordList;
  ...
  strict private
    ...
    FGlyphOffsets: TIntegerDynArray;
    FSubsetGlyphs: TdxFontFileSubsetGlyphList;
...
uses
  System.Math, dxTypeHelpers, dxStringHelper, dxGenerics, dxPDFTypes, dxPDFUtils, dxPDFType1Font;
...
type
  ...
  TEncodingPairList = class(TList<TEncodingPair>)
  public
    constructor Create;
  end;
...
constructor TEncodingPairList.Create;
begin
  inherited Create{$IFDEF DELPHI12}(IComparer<TEncodingPair>(TdxComparer<TEncodingPair>.Default)){$ENDIF};
end;

{ TdxFontFileSubsetGlyphList }

constructor TdxFontFileSubsetGlyphList.Create;
begin
  inherited Create{$IFDEF DELPHI12}(IComparer<TdxFontFileSubsetGlyph>(TdxComparer<TdxFontFileSubsetGlyph>.Default)){$ENDIF};
end;
...
var
  ALength, I: Integer;
begin
  ALength := System.Math.Min(Length(AEncoding), Length(FGlyphIdArray));
...
function TdxFontFileCMapTable.TryCreateRecord(APlatformId: TdxFontFilePlatformID; AEncodingId: TdxFontFileEncodingID;
  AFormat: TdxFontFileCMapFormatID; AStream: TdxFontFileStream; out ARecord: TdxFontFileCMapCustomFormatRecord): Boolean;
begin
  case AFormat of
    TdxFontFileCMapFormatID.ByteEncoding:
      ARecord := TdxFontFileCMapByteEncodingRecord.Create(APlatformId, AEncodingId, AStream);
    TdxFontFileCMapFormatID.HighByteMappingThrough:
      ARecord := TdxFontFileCMapHighByteMappingThroughRecord.Create(APlatformId, AEncodingId, AStream);
    TdxFontFileCMapFormatID.SegmentMapping:
      ARecord := TdxFontFileCMapSegmentMappingRecord.Create(APlatformId, AEncodingId, AStream);
    TdxFontFileCMapFormatID.TrimmedMapping:
      ARecord := TdxFontFileCMapTrimmedMappingRecord.Create(APlatformId, AEncodingId, AStream);
    TdxFontFileCMapFormatID.MixedCoverage:
      ARecord := TdxFontFileCMapMixedCoverageRecord.Create(APlatformId, AEncodingId, AStream);
    TdxFontFileCMapFormatID.TrimmedArray:
      ARecord := TdxFontFileCMapTrimmedArrayRecord.Create(APlatformId, AEncodingId, AStream);
    TdxFontFileCMapFormatID.SegmentedCoverage:
      ARecord := TdxFontFileCMapSegmentedCoverageRecord.Create(APlatformId, AEncodingId, AStream);
    TdxFontFileCMapFormatID.ManyToOneRangeMapping:
      ARecord := TdxFontFileCMapManyToOneRangeMappingRecord.Create(APlatformId, AEncodingId, AStream);
    TdxFontFileCMapFormatID.UnicodeVariationSequences:
      ARecord := TdxFontFileCMapUnicodeVariationSequenciesRecord.Create(APlatformId, AEncodingId, AStream);
  else
    ARecord := nil;
  end;
  Result := ARecord <> nil;
...
{ TdxFontFileNameRecordList }

constructor TdxFontFileNameRecordList.Create;
begin
  inherited Create{$IFDEF DELPHI12}(IComparer<TdxFontFileNameRecord>(TdxComparer<TdxFontFileNameRecord>.Default)){$ENDIF};
end;
...
begin
  ...
  FNamingTable := TdxFontFileNameRecordList.Create;
  FFamilyName := '';
  FMacFamilyName := '';
  FPostScriptName := '';
  if DataSize > 6 then
...
var
  I: Integer;
  A160B341E657034191D662B0410001671: TBytes;
begin
  SetLength(A160B341E657034191D662B0410001671, 0);
  inherited Create(A160B341E657034191D662B0410001671);
...
{ TdxFontFileCMapGlyphRangeList }

constructor TdxFontFileCMapGlyphRangeList.Create;
begin
  inherited Create{$IFDEF DELPHI12}(IComparer<TdxFontFileCMapGlyphRange>(TdxComparer<TdxFontFileCMapGlyphRange>.Default)){$ENDIF};
end;

{ TdxFontFileCMapRowList }

constructor TdxFontFileCMapRowList.Create;
begin
  inherited Create{$IFDEF DELPHI12}(IComparer<TdxFontFileCMapRow>(TdxComparer<TdxFontFileCMapRow>.Default)){$ENDIF};
end;
...
begin
  if FSubsetGlyphs = nil then
    FSubsetGlyphs := TdxFontFileSubsetGlyphList.Create;
  FSubsetGlyphs.Clear;
...
var
  A160B341E657034191D662B0410001671: Integer;
begin
  for A160B341E657034191D662B0410001671 := 0 to Length(FVariationSelectorRecords) - 1do
    FVariationSelectorRecords[A160B341E657034191D662B0410001671].Free;
  inherited Destroy;
end;
...
var
  ...
  AEncodingId: TdxFontFileEncodingID;
  APosition: Int64;
  ARecord: TdxFontFileCMapCustomFormatRecord;
begin
  inherited Create(AData);
  FCMapTables := TObjectList<TdxFontFileCMapCustomFormatRecord>.Create;
  FMappedGlyphCache := TdxPDFIntegerIntegerDictionary.Create;
  ...
  begin
    ...
    DataStream.Position := AOffset;
    try
      if TryCreateRecord(APlatformId, AEncodingId, TdxFontFileCMapFormatID(DataStream.ReadShort), DataStream, ARecord) then
        FCMapTables.Add(ARecord);
    except
    end;
...
var
  AGlyphIndexes: TEncodingPairList;
...
begin
  ...
  AGlyphIndexes := TEncodingPairList.Create;
...
function TdxFontFileCMapSegmentMappingRecord.GetGlyphRanges: TdxFontFileCMapGlyphRangeList;
var
  I: Integer;
  AEnd: SmallInt;
  A160B341E657034191D662B0410001671: TdxFontFileCMapGlyphRange;
begin
  if FGlyphRanges = nil then
  begin
    FGlyphRanges := TdxFontFileCMapGlyphRangeList.Create;
    for I := 0 to FSegCount - 1 do
    begin
      AEnd := FEndCode[I];
      if AEnd = -1 then
        Break;
      A160B341E657034191D662B0410001671.StartValue := FStartCode[I];
      A160B341E657034191D662B0410001671.EndValue := AEnd;
      FGlyphRanges.Add(A160B341E657034191D662B0410001671);
    end;
  end;
  Result := FGlyphRanges;
end;
...
begin
  ...
  begin
    ...
    begin
      AList := TdxFontFileCMapRowList.Create;
      try
...
{ TdxFontFileCMapSegmentMappingRecord.TMap }
...
{ TdxFontFileCMapSegmentMappingRecord.TMapList }

constructor TdxFontFileCMapSegmentMappingRecord.TMapList.Create;
begin
  inherited Create{$IFDEF DELPHI12}(IComparer<TMap>(TdxComparer<TMap>.Default)){$ENDIF};
end;
...
const
  A160B341E657034191D662B0410001671 = 'head';
begin
  Result := A160B341E657034191D662B0410001671;
end;
...
begin
    //.. Evitando errores con duplicados
    If   not FTableDictionary.ContainsKey(ATable.Name)
    then FTableDictionary.Add(ATable.Name, ATable);
end;
