...
unit dxRichEdit.Dialogs.FontsHelper; // for internal use
...
uses
  System.UITypes,
  System.Classes, System.SysUtils, Vcl.Graphics, Vcl.Controls, cxEdit, cxListBox, cxTextEdit,
  dxCoreClasses, cxDropDownEdit, cxCheckBox, cxLookAndFeelPainters, dxCoreGraphics,
  dxRichEdit.Options,
  dxRichEdit.Utils.Types,
  dxLayoutContainer, dxFontHelpers,
...
type
  ...
  private
    ...
    FAllCapsCheckBox: TdxLayoutCheckBoxItem;
    FDoubleStrikethroughCheckBox: TdxLayoutCheckBoxItem;
    FHiddenCheckBox: TdxLayoutCheckBoxItem;
    FStrikethroughCheckBox: TdxLayoutCheckBoxItem;
    FSubscriptCheckBox: TdxLayoutCheckBoxItem;
    FSuperscriptCheckBox: TdxLayoutCheckBoxItem;
    FUnderlineWordsOnlyCheckBox: TdxLayoutCheckBoxItem;
  ...
  protected
    ...
    procedure UpdateCheckEdit(ACheckBox: TdxLayoutCheckBoxItem; const AState: TdxNullableBoolean);
    { IdxBatchUpdateHandler }
    procedure OnLastEndUpdate; override;
  public
    constructor Create(const AAllCaps, ADoubleStrikethrough, AHidden, AStrikethrough, ASubscript, ASuperscript, AUnderlineWordsOnly: TdxLayoutCheckBoxItem);
  ...
  protected
    ...
    procedure FontSizeValidating(Sender: TcxCustomEdit; var DisplayValue: Variant; var ErrorText: TCaption;  //..
      var Error: Boolean);
    procedure FontStyleValidating(Sender: TcxCustomEdit; var DisplayValue: Variant; var ErrorText: TCaption;  //..
      var Error: Boolean);
...
uses
  System.Math, System.Variants, cxVariants, cxClasses, dxCore,
  dxRichEdit.Dialogs.Strs,
  dxRichEdit.Utils.PredefinedFontSizeCollection,
  dxRichEdit.Dialogs.EditStyleHelper, dxGDIPlusAPI, dxGDIPlusClasses, Winapi.Windows;
...
begin
  ...
  FFontsList := TdxFontCache.CreateSystemTrueTypeFonts;
end;
...
constructor TdxRichEditFontEffectsHelper.Create(const AAllCaps, ADoubleStrikethrough, AHidden, AStrikethrough, ASubscript,
  ASuperscript, AUnderlineWordsOnly: TdxLayoutCheckBoxItem);
begin
  inherited Create;
...
begin
  FStrikethroughCheckBox.OnClick := StrikethroughCheckedChanged;
  FDoubleStrikethroughCheckBox.OnClick := DoubleStrikethroughCheckedChanged;
  FSuperscriptCheckBox.OnClick := SuperscriptCheckedChanged;
  FSubscriptCheckBox.OnClick := SubscriptCheckedChanged;
  FAllCapsCheckBox.OnClick := AllCapsCheckedChanged;
  FHiddenCheckBox.OnClick := HiddenCheckedChanged;
  FUnderlineWordsOnlyCheckBox.OnClick := UnderlineWordsOnlyCheckedChanged;
end;
...
begin
  FStrikethroughCheckBox.OnClick := nil;
  FDoubleStrikethroughCheckBox.OnClick := nil;
  FSuperscriptCheckBox.OnClick := nil;
  FSubscriptCheckBox.OnClick := nil;
  FAllCapsCheckBox.OnClick := nil;
  FHiddenCheckBox.OnClick := nil;
  FUnderlineWordsOnlyCheckBox.OnClick := nil;
end;
...
procedure TdxRichEditFontEffectsHelper.UpdateCheckEdit(ACheckBox: TdxLayoutCheckBoxItem; const AState: TdxNullableBoolean);
begin
  if AState.IsNull then
  begin
    ACheckBox.CheckBoxOptions.AllowGrayed := True;
...
begin
  ...
  begin
    FStrikethroughCheckBox.CheckBoxOptions.AllowGrayed := True;
    FDoubleStrikethroughCheckBox.CheckBoxOptions.AllowGrayed := True;
...
begin
  ...
  begin
    FSuperscriptCheckBox.CheckBoxOptions.AllowGrayed := True;
    FSubscriptCheckBox.CheckBoxOptions.AllowGrayed := True;
...
procedure TdxRichEditFontHelper.FontSizeValidating(Sender: TcxCustomEdit; var DisplayValue: Variant; var ErrorText: TCaption;  //..
  var Error: Boolean);
var
  AText: string;
begin
...
procedure TdxRichEditFontHelper.FontStyleValidating(Sender: TcxCustomEdit; var DisplayValue: Variant; var ErrorText: TCaption;  //..
  var Error: Boolean);
begin
  Error := False;
  if VarIsSoftNull(DisplayValue) then
...
begin
  UnsubscribeControlsEvents;
  AStrings := TdxFontCache.CreateSystemTrueTypeFonts;
  try
    ListControl.Items.BeginUpdate;
    ListControl.Items.Clear;
