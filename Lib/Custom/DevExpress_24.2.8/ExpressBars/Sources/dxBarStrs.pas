...
resourcestring
  ...
  dxSBAR_DATECLEAR = 'Limpiar';
  dxSBAR_DATEDIALOGCAPTION = 'Selecione la fecha';
  dxSBAR_TREEVIEWDIALOGCAPTION = 'Seleccion elemento';
  dxSBAR_IMAGEDIALOGCAPTION = 'Seleccion elemento';
  dxSBAR_IMAGEINDEX = 'Índice de imagen';
  dxSBAR_IMAGETEXT = 'Texto';
  dxSBAR_PLACEFORCONTROL = 'El lugar para el ';
  dxSBAR_CANTASSIGNCONTROL = 'You cannot assign the same control to more than one TdxBarControlContainerItem';
  dxSBAR_CXEDITVALUEDIALOGCAPTION = 'Introduzca valor';
  ...
  dxSBAR_CANTPLACERIBBONCOMPOSITEITEM = 'You can place TdxRibbonCompositeItem into a submenu or Ribbon control';
  dxSBAR_CANTPLACERIBBONSKINSELECTOR = 'You can place a TdxRibbonSkinSelector component only into a Ribbon control';
  dxSBAR_CANTPLACESKINCHOOSERGALLERY = 'You can place TdxSkinChooserGalleryItem into a submenu or Ribbon control';
  dxSBAR_CANTPLACEPALETTECHOOSERGALLERY = 'You can place TdxSkinChooserGalleryPaletteItem into a submenu or Ribbon control';
  dxSBAR_PALETTECHOOSEREMPTYITEMCAPTION = 'Select a vector skin to unlock swatches.';
  dxSBAR_PALETTECHOOSEREMPTYITEMDESCRIPTION = 'Swatches are color palettes that modify the skin color scheme.';
  dxSBAR_DEFAULTSKINCHOOSERCAPTION = 'Skin Name';
  dxSBAR_DEFAULTSEARCHEDITHINT = 'Search';
  dxSBAR_DEFAULTPALETTECHOOSERCAPTION = 'Color Palette';
  dxSBAR_CANTPLACERIBBONCOMPOSITEITEMCONTROLFORSUBMENU = 'You cannot embed a TdxRibbonCompositeItemControl into a drop-down window';
  dxSBAR_CANTPLACERIBBONSKINSELECTORFORSUBMENU = 'You cannot embed a TdxRibbonSkinSelector component into a drop-down window';
  ...
  dxSBAR_RIBBONMINIMIZEBUTTON_LAYOUTSEPARATOR_CAPTION = 'Ribbon Layout';
  dxSBAR_RIBBONMINIMIZEBUTTON_CLASSIC_CAPTION = 'Classic';
  dxSBAR_RIBBONMINIMIZEBUTTON_SIMPLIFIED_CAPTION = 'Simplified';

  dxSBAR_RIBBONMINIMIZEBUTTON_SHOWSEPARATOR_CAPTION = 'Show Ribbon';
  dxSBAR_RIBBONMINIMIZEBUTTON_AUTOHIDERIBBON_CAPTION = 'Auto-hide Ribbon';
  dxSBAR_RIBBONMINIMIZEBUTTON_AUTOHIDERIBBON_DESCRIPTION = 'Hide the Ribbon. Click at the top of the application to show it.';
  dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABS_CAPTION = 'Show Tabs Only';
  dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABS_DESCRIPTION = 'Show Ribbon tabs only. Click a tab to show the commands.';
  dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABSANDCOMMANDS_CAPTION = 'Show Tabs and Commands';
  dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABSANDCOMMANDS_DESCRIPTION = 'Show Ribbon tabs and commands all the time.';

  dxSBAR_RIBBONMINIMIZEBUTTON_QATVISIBILITY_CAPTION = 'Quick Access Toolbar Visibility';
  ...
  dxSBAR_NEWSKINPALETTECHOOSERGALLERYITEMCAPTION = 'New Palette Chooser';
  dxSBAR_NEWSKINCHOOSERGALLERYITEMCAPTION = 'New Skin Chooser';
  dxSBAR_NEWRIBBONCOMPOSITEITEMCAPTION = 'New Ribbon Composite Item';
  dxSBAR_NEWRIBBONSKINSELECTORCAPTION = 'New Skin Selector';
  dxSBAR_NEWBARCUSTOMCOMPOSITEITEMCAPTION = 'New Composite Item';
  ...
  dxSBAR_CP_ADDDEPRECATED = 'Deprecated Items';
  ...
  dxSBAR_NOBARMANAGER = 'Unable to proceed. You must first assign a TdxBarManager to the component''s BarManager property';
  ...
  dxSBAR_MORECOMMANDS = '&Mas comandos...';
  ...
  dxSBAR_MINIMIZERIBBON = 'Mi&nimizar la cinta';
  dxSBAR_CUSTOMIZERIBBON = 'Pe&rsonalizar la cinta...';
  ...
  dxSBAR_RIBBON_CAPTIONAREASEARCHTOOLBARNAME = 'Caption Area Search Toolbar';
...
begin
  ...
  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_LAYOUTSEPARATOR_CAPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_LAYOUTSEPARATOR_CAPTION);
  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_CLASSIC_CAPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_CLASSIC_CAPTION);
  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_SIMPLIFIED_CAPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_SIMPLIFIED_CAPTION);

  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_SHOWSEPARATOR_CAPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_SHOWSEPARATOR_CAPTION);
  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_AUTOHIDERIBBON_CAPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_AUTOHIDERIBBON_CAPTION);
  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_AUTOHIDERIBBON_DESCRIPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_AUTOHIDERIBBON_DESCRIPTION);
  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABS_CAPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABS_CAPTION);
  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABS_DESCRIPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABS_DESCRIPTION);
  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABSANDCOMMANDS_CAPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABSANDCOMMANDS_CAPTION);
  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABSANDCOMMANDS_DESCRIPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_SHOWTABSANDCOMMANDS_DESCRIPTION);

  InternalAdd('dxSBAR_RIBBONMINIMIZEBUTTON_QATVISIBILITY_CAPTION', @dxSBAR_RIBBONMINIMIZEBUTTON_QATVISIBILITY_CAPTION);
  ...
  InternalAdd('dxSBAR_CP_ADDDEPRECATED', @dxSBAR_CP_ADDDEPRECATED);
  ...
  InternalAdd('dxSBAR_RIBBON_CAPTIONAREASEARCHTOOLBARNAME', @dxSBAR_RIBBON_CAPTIONAREASEARCHTOOLBARNAME);
  ...
  InternalAdd('dxSBAR_CANTPLACERIBBONCOMPOSITEITEM', @dxSBAR_CANTPLACERIBBONCOMPOSITEITEM);
  InternalAdd('dxSBAR_CANTPLACESKINCHOOSERGALLERY', @dxSBAR_CANTPLACESKINCHOOSERGALLERY);
  InternalAdd('dxSBAR_CANTPLACERIBBONSKINSELECTOR', @dxSBAR_CANTPLACERIBBONSKINSELECTOR);
  InternalAdd('dxSBAR_CANTPLACEPALETTECHOOSERGALLERY', @dxSBAR_CANTPLACEPALETTECHOOSERGALLERY);
  InternalAdd('dxSBAR_PALETTECHOOSEREMPTYITEMCAPTION', @dxSBAR_PALETTECHOOSEREMPTYITEMCAPTION);
  InternalAdd('dxSBAR_PALETTECHOOSEREMPTYITEMDESCRIPTION', @dxSBAR_PALETTECHOOSEREMPTYITEMDESCRIPTION);
  InternalAdd('dxSBAR_DEFAULTSKINCHOOSERCAPTION', @dxSBAR_DEFAULTSKINCHOOSERCAPTION);
  InternalAdd('dxSBAR_DEFAULTSEARCHEDITHINT', @dxSBAR_DEFAULTSEARCHEDITHINT);
  InternalAdd('dxSBAR_DEFAULTPALETTECHOOSERCAPTION', @dxSBAR_DEFAULTPALETTECHOOSERCAPTION);
  InternalAdd('dxSBAR_CANTPLACERIBBONCOMPOSITEITEMCONTROLFORSUBMENU', @dxSBAR_CANTPLACERIBBONCOMPOSITEITEMCONTROLFORSUBMENU);
  InternalAdd('dxSBAR_CANTPLACERIBBONSKINSELECTORFORSUBMENU', @dxSBAR_CANTPLACERIBBONSKINSELECTORFORSUBMENU);

  InternalAdd('dxSBAR_NEWSKINPALETTECHOOSERGALLERYITEMCAPTION', @dxSBAR_NEWSKINPALETTECHOOSERGALLERYITEMCAPTION);
  InternalAdd('dxSBAR_NEWSKINCHOOSERGALLERYITEMCAPTION', @dxSBAR_NEWSKINCHOOSERGALLERYITEMCAPTION);
  InternalAdd('dxSBAR_NEWRIBBONCOMPOSITEITEMCAPTION', @dxSBAR_NEWRIBBONCOMPOSITEITEMCAPTION);
  InternalAdd('dxSBAR_NEWRIBBONSKINSELECTORCAPTION', @dxSBAR_NEWRIBBONSKINSELECTORCAPTION);
  InternalAdd('dxSBAR_NEWBARCUSTOMCOMPOSITEITEMCAPTION', @dxSBAR_NEWBARCUSTOMCOMPOSITEITEMCAPTION);
end;
