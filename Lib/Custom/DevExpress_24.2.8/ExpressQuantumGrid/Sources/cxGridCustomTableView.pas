...
uses
  ...
  dxCoreGraphics, dxCustomFunction;
...
var
  I: Integer;
  A110B35036260310502776A1925121065: TcxCustomGridRecord;
begin
  if NeedChangeLayoutOnSelectionChanged(AInfo) then
    ...
    begin
      A110B35036260310502776A1925121065 := ViewData.GetRecordByIndex(AInfo.RowIndexes[I]);
      if A110B35036260310502776A1925121065 <> nil then A110B35036260310502776A1925121065.Invalidate;
    end;
