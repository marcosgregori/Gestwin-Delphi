...
resourcestring
  ...
  sdxPreviewBottomMargin = 'Margen inferior';
  sdxPreviewHeaderMargin = 'Cabecera';
  sdxPreviewFooterMargin = 'Pie';
  sdxPreviewLeftMargin = 'Margen izquierdo';
  sdxPreviewRightMargin = 'Margen derecho';
  sdxPreviewTopMargin = 'Margen superior';

  sdxPreviewNoPages = 'No hay páginas que mostrar';
  ...
  sdxPreviewOutOfResources = 'Sin recursos';
...
const
  dxThisUnitName = 'dxCustomPreviewStrs';
