...
resourcestring
  scxBuiltInLookAndFeelStyles = 'Estilos de apariencia incorporados';
  scxCantCreateRegistryKey = 'No puedo crear la clave del registro: \%s';
  scxCantOpenRegistryKey   = 'No puedo abrir la clave del registro: \%s';  
  scxConverterCantCreateStyleRepository = 'No puedo crear el repositorio de estilos';
  scxErrorStoreObject = 'Error almacenando el objeto %s';  
  scxLockedStateText = 'Por favor, espere...';
  ...
  cxSDateWednesday                   = 'Miercoles';
  cxSDateThursday                    = 'Jueves';
  cxSDateFriday                      = 'Viernes';
  cxSDateSaturday                    = 'Sabado';
  ...
  cxSDateFifth                       = 'quinto';
  cxSDateSixth                       = 'sexto';
  cxSDateSeventh                     = 'septimo';
  cxSDateBOM                         = 'pdm';
  cxSDateEOM                         = 'fdm';
  cxSDateNow                         = 'ahora';

  // Quick Customization commands
  scxQuickCustomizationAllCommandCaption    = '(Todo)';
  scxQuickCustomizationSortedCommandCaption = '(Ordenado)';
  // UIA
  scxColumnHeaderAscendingOrderUIAStatus = 'Ordeenado (Ascendente)';
  scxColumnHeaderDescendingOrderUIAStatus = 'Ordenado (Descendente)';
...
begin
  ...
  InternalAdd('scxColumnHeaderAscendingOrderUIAStatus', @scxColumnHeaderAscendingOrderUIAStatus);
  InternalAdd('scxColumnHeaderDescendingOrderUIAStatus', @scxColumnHeaderDescendingOrderUIAStatus);
end;
