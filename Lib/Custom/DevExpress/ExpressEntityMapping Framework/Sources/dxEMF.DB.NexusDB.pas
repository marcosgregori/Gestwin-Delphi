...
{                                                                    }
{           Copyright (c) 2016-2020 Developer Express Inc.           }
{           ALL RIGHTS RESERVED                                      }
{                                                                    }
...
unit dxEMF.DB.NexusDB;

{$HPPEMIT '#pragma link "dxEMF.DB.NexusDB"'}
...
type
  { TdxNexusDBConnectionProvider }

  TdxNexusDBConnectionProvider = class(TdxSQLConnectionProvider)
...
{ TdxNexusDBConnectionProvider.TVersion }

constructor TdxNexusDBConnectionProvider.TVersion.Create(const AVersion: string);
var
...
procedure TdxNexusDBConnectionProvider.TVersion.Empty;
begin
  HasValue := False;
  MajorHi := 0;
  MajorLo := 0;
...
function TdxNexusDBConnectionProvider.TVersion.Support(AMajorHi, AMajorLo, AMinor: Byte): Boolean;
begin
...
constructor TdxNexusDBConnectionProvider.Create(
...
class function TdxNexusDBConnectionProvider.GetDBEngine: TdxDBEngine;
begin
  Result := TdxDBEngines.NexusDB;
end;

function TdxNexusDBConnectionProvider.FormatBinary(
...
procedure TdxNexusDBConnectionProvider.CreateTable(ATable: TdxDBTable);
var
  AKey: TdxDBColumn;
...
procedure TdxNexusDBConnectionProvider.CreateIndex(ATable: TdxDBTable; AIndex: TdxDBIndex);
begin
  if ATable.Name <> 'XPObjectType' then
    inherited CreateIndex(ATable, AIndex);
end;

function TdxNexusDBConnectionProvider.FormatColumn(const AColumnName: string): string;
begin
...
function TdxNexusDBConnectionProvider.FormatColumn(const AColumnName, ATableAlias: string): string;
begin
  Result := ATableAlias + '.' + FormatColumn(AColumnName);
end;

function TdxNexusDBConnectionProvider.FormatConstraint(const AConstraintName: string): string;
begin
  if not CaseSensitiveFieldNames then
...
function TdxNexusDBConnectionProvider.FormatFunction(AOperatorType: TdxFunctionOperatorType;
...
function TdxNexusDBConnectionProvider.FormatFunction(AProcessParameter: TdxProcessParameter;
...
function TdxNexusDBConnectionProvider.FormatTable(const ATableName: string): string;
begin
    Result := '"' + ATableName + '"'
end;

function TdxNexusDBConnectionProvider.FormatTable(const ASchemaName: string; const ATableName: string): string;
begin
  Result := FormatTable(ATableName);
end;

function TdxNexusDBConnectionProvider.FormatTable(const ASchemaName: string; const ATableName: string; const ATableAlias: string): string;
begin
  Result := FormatTable(ATableName) + ' ' + ATableAlias;
end;

function TdxNexusDBConnectionProvider.FormatSelect(const ASelectedPropertiesSQL, AFromSQL, AWhereSQL, AOrderBySQL, AGroupBySQL, AHavingSQL: string;
...
function TdxNexusDBConnectionProvider.FormatOrder(const ASortProperty: string; ASortDirection: TdxSortDirection): string;
begin
...
function TdxNexusDBConnectionProvider.FormatInsert(
  const ATableName, AFieldNames, AValuesClause: string): string;
begin
  Result := 'insert into ' + ATableName + '(' + AFieldNames + ')values(' + AValuesClause + ')';
end;

function TdxNexusDBConnectionProvider.FormatInsertDefaultValues(ATable: TdxDBTable): string;
begin
  Result := 'insert into ' + FormatTableSafe(ATable) +' values()';
end;

function TdxNexusDBConnectionProvider.FormatUpdate(const ATableName, ASetClause, AWhereClause: string): string;
begin
  Result := Format('update %s set %s where %s', [ATableName, ASetClause, AWhereClause]);
end;

function TdxNexusDBConnectionProvider.FormatDelete(const ATableName, AWhereClause: string): string;
begin
  Result := Format('delete from %s where %s', [ATableName, AWhereClause]);
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnFullAttributes(
...
function TdxNexusDBConnectionProvider.GetStorageTableNames(AIncludeViews: Boolean): TArray<string>;
var
  AQuery: TdxQuery;
  ADataSet: TDataSet;
  AList: TList<string>;
...
function TdxNexusDBConnectionProvider.GetParameterName(const AParameter: IdxOperandValue;
...
begin
  ...
  if Supports(AParameter, IdxConstantValue) and not AValue.IsNullOrEmpty then
  begin
    case AValue.Kind of
      tkInteger:
...
procedure TdxNexusDBConnectionProvider.GetTableSchema(
...
function TdxNexusDBConnectionProvider.SupportsNativeSkipTake: Boolean;
begin
  Result := True;
end;

function TdxNexusDBConnectionProvider.SupportsNativeOuterApply: Boolean;
begin
  Result := True;
end;

function TdxNexusDBConnectionProvider.GetVersion: TVersion;
begin
...
function TdxNexusDBConnectionProvider.IsSequenceExists(const ASequenceName: string): Boolean;
var
  AQuery: TdxQuery;
begin
...
class destructor TdxNexusDBConnectionProvider.Destroy;
begin
  FreeAndNil(FConnectionParameters);
  FreeAndNil(FDBTypes);
end;

class function TdxNexusDBConnectionProvider.GetConnectionParameters: TDictionary<string, TdxConnectionParameterValues>;
begin
...
class procedure TdxNexusDBConnectionProvider.PopulateDBTypes;
begin
...
function TdxNexusDBConnectionProvider.ConvertToDBParameter(const AParameterValue: TValue): TValue;
const
...
class function TdxNexusDBConnectionProvider.GetColumnTypeByInfo(
...
class function TdxNexusDBConnectionProvider.GetDBTypes: TDictionary<string, TdxDBColumnType>;
begin
...
procedure TdxNexusDBConnectionProvider.ReadDbVersion;
var
  AQuery: TdxQuery;
...
function TdxNexusDBConnectionProvider.GetMaximumStringSize: Integer;
begin
  Result := MaximumStringSize;
end;

function TdxNexusDBConnectionProvider.GetSafeNameTableMaxLength: Integer;
begin
  Result := 31;
end;

function TdxNexusDBConnectionProvider.GetFunctionStrLenName: string;
begin
  if Version.Support(2, 1) then
    Result := 'CHAR_LENGTH'
  else
...
procedure TdxNexusDBConnectionProvider.GetColumns(ATable: TdxDBTable);
var
  AColumn: TdxDBColumn;
  ADataSet: TDataSet;
  AQuery: TdxQuery;
...
function TdxNexusDBConnectionProvider.GetSeqName(ATable: TdxDBTable): string;
var
  ASequenceName: string;
begin
...
procedure TdxNexusDBConnectionProvider.GetIndexes(ATable: TdxDBTable);
var
  AQuery: TdxQuery;
  ADataSet: TDataSet;
  AIndex: TdxDBIndex;
...
procedure TdxNexusDBConnectionProvider.GetPrimaryKey(ATable: TdxDBTable);
var
  AQuery: TdxQuery;
  ADataSet: TDataSet;
  AColumn: TdxDBColumn;
...
function TdxNexusDBConnectionProvider.GetFieldStringValue(AField: TField): string;
begin
  Result := Trim(VarToStr(GetFieldValue(AField)));
end;

function TdxNexusDBConnectionProvider.GetFieldValue(AField: TField): Variant;
begin
...
function TdxNexusDBConnectionProvider.GetFieldValueDef(AField: TField; const ADefValue: Variant): Variant;
begin
...
procedure TdxNexusDBConnectionProvider.GetForeignKeys(ATable: TdxDBTable);
var
  AQuery: TdxQuery;
  ADataSet: TDataSet;
...
type
  TdxNexusDBIdentityInsertSqlGenerator = class(TdxInsertSQLGenerator)
  protected
    function InternalGenerateSQL: string; override;
  end;

function TdxNexusDBIdentityInsertSqlGenerator.InternalGenerateSQL: string;
var
  I: Integer;
...
function TdxNexusDBConnectionProvider.GetIdentity(ARoot: TdxInsertStatement; AIdentities: TdxTaggedParameterHolder): Int64;
var
  Id64: Int64;
  Id32: Integer;
  AValue: Variant;
  AQuery: TdxQuery;
  ASQL: TdxQuery;
  AGenerator: TdxNexusDBIdentityInsertSqlGenerator;
begin
  ...
  AGenerator := TdxNexusDBIdentityInsertSqlGenerator.Create(Self, AIdentities);
  try
    ...
    try
      case ARoot.IdentityColumnType of
        TdxDBColumnType.Int32:
          begin
            Id32 := Result;
            ASQL.AppendParameter('seq', TdxOperandValue.Create(Id32));
          end;
        TdxDBColumnType.Int64:
          begin
            Id64 := Result;
            ASQL.AppendParameter('seq', TdxOperandValue.Create(Id64));
          end
        else
          raise ENotSupportedException.Create('');
      end;
...
function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForBoolean(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'char(1)';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForByte(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'numeric(3,0)';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForSByte(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'numeric(3,0)';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForChar(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'char CHARACTER SET UNICODE_FSS';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForDecimal(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'decimal(18,4)';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForDouble(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'double precision';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForSingle(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'float';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForInt32(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'integer';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForUInt32(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'numeric(10,0)';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForInt16(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'smallint';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForUInt16(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'numeric(5,0)';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForInt64(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'bigint';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForUInt64(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'numeric(18,0)';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForString(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
...
function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForDateTime(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'timestamp';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForGuid(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'char(36)';
end;

function TdxNexusDBConnectionProvider.GetSQLCreateColumnTypeForByteArray(ATable: TdxDBTable; AColumn: TdxDBColumn): string;
begin
  Result := 'blob';
end;

function TdxNexusDBConnectionProvider.CollectTablesToCreate(const ATables: TArray<TdxDBTable>): TArray<TdxDBTable>;
const
...
var
  ...
  ATable: TdxDBTable;
  AList: TdxArray<TdxDBTable>;
  AStrList, AParamNames: TStringList;
  AValue: Boolean;
  AParameters: TdxQueryParameterCollection;
begin
  Result := nil;
  AList := TdxArray<TdxDBTable>.Create(Length(ATables));
...
initialization
  TdxSQLConnectionProviderFactory.Register(TdxNexusDBConnectionProvider);

finalization
  TdxSQLConnectionProviderFactory.Unregister(TdxNexusDBConnectionProvider);
