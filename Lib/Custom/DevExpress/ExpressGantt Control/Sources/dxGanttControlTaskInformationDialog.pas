...
uses
  System.UITypes,
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Generics.Defaults, System.Generics.Collections, System.Variants, System.Classes, Vcl.Graphics, Vcl.Controls, Vcl.Forms,
  Vcl.ComCtrls, Vcl.Dialogs,
  dxForms, cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters, dxLayoutcxEditAdapters,
  dxLayoutControlAdapters, cxContainer, cxEdit, Vcl.Menus, Vcl.StdCtrls, cxButtons, dxLayoutContainer, cxSpinEdit,
...
type
  ...
  protected
    ...
    procedure DurationEditValidateHandler(Sender: TcxCustomEdit; var DisplayValue: Variant; var ErrorText: TCaption;  //..
      var Error: Boolean);
    procedure PercentEditIncrementValueHandler(Sender: TObject; AButton: TcxSpinEditButton;
      var AValue: Variant; var AHandled: Boolean);
    procedure PercentEditValidateHandler(Sender: TcxCustomEdit; var DisplayValue: Variant; var ErrorText: TCaption;  //..
      var Error: Boolean);
...
procedure TdxGanttControlTaskInformationDialogForm.DurationEditValidateHandler(Sender: TcxCustomEdit;   //..
...
procedure TdxGanttControlTaskInformationDialogForm.PercentEditValidateHandler(Sender: TcxCustomEdit;  //..
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
var
  AValue: Variant;
  AFloatValue: Double;
