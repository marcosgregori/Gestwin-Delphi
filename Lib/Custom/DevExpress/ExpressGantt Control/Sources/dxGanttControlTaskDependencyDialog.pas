...
uses
  ...
  Vcl.Dialogs, dxForms, cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters, dxLayoutcxEditAdapters,
...
type
  ...
  protected
    ...
    procedure LagEditValidateHandler(Sender: TcxCustomEdit; var DisplayValue: Variant; var ErrorText: TCaption;  //..
      var Error: Boolean);
...
procedure TdxGanttControlTaskDependencyDialogForm.LagEditValidateHandler(Sender: TcxCustomEdit;  //..
