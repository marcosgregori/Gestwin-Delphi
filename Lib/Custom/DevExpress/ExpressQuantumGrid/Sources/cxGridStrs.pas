...
resourcestring
  ...
  scxGridColumnHeaderUndefinedFilterButtonUIAName = 'Filter dropdown';
  scxGridColumnHeaderDefinedFilterButtonUIAName = 'Filter dropdown (filtered)';
  scxGridColumnHeaderFilteredUIAStatus = 'Filtered';
...
begin
  ...
  InternalAdd('scxGridColumnHeaderUndefinedFilterButtonUIAName', @scxGridColumnHeaderUndefinedFilterButtonUIAName);
  InternalAdd('scxGridColumnHeaderDefinedFilterButtonUIAName', @scxGridColumnHeaderDefinedFilterButtonUIAName);
  InternalAdd('scxGridColumnHeaderFilteredUIAStatus', @scxGridColumnHeaderFilteredUIAStatus);
end;
