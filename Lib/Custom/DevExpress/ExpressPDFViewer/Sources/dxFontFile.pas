...
var
  I: Integer;
  A160B341E657034181D662B071000167A: TBytes;
begin
  SetLength(A160B341E657034181D662B071000167A, 0);
  inherited Create(A160B341E657034181D662B071000167A);
...
var
  A160B341E657034181D662B071000167A: Integer;
begin
  for A160B341E657034181D662B071000167A := 0 to Length(FVariationSelectorRecords) - 1do
    FVariationSelectorRecords[A160B341E657034181D662B071000167A].Free;
  inherited Destroy;
end;
...
var
  I: Integer;
  AEnd: SmallInt;
  A160B341E657034181D662B071000167A: TdxFontFileCMapGlyphRange;
begin
  ...
  begin
    ...
    begin
      ...
      if AEnd = -1 then
        Break;
      A160B341E657034181D662B071000167A.StartValue := FStartCode[I];
      A160B341E657034181D662B071000167A.EndValue := AEnd;
      FGlyphRanges.Add(A160B341E657034181D662B071000167A);
    end;
  end;
  Result := FGlyphRanges;
end;
...
const
  A160B341E657034181D662B071000167A = 'head';
begin
  Result := A160B341E657034181D662B071000167A;
end;
