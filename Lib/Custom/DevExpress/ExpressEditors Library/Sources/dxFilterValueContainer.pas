...
uses
  System.UITypes,
  System.Classes, Winapi.Windows, Vcl.Controls, Vcl.ImgList, Vcl.ComCtrls, cxContainer, cxControls, cxListBox, cxLookAndFeelPainters, dxCore, dxCoreClasses,
  ...
  cxCalendar, cxEdit, dxUIElementPopupWindow, cxGraphics, dxTreeView, System.Generics.Collections, cxFilterControlUtils, dxCustomTree,
  cxMaskEdit, dxCustomFunction, dxTypeHelpers;
...
type
  ...
  TdxExcelFilterValueContainerPredefinedFiltersCondition = class;
  ...
  TdxExcelFilterValueContainerCustomDateTimeTreeView = class;
  TdxExcelFilterValueContainerDateValuesComboBoxProperties = class;
  ...
  IdxFilterImagesProvider = interface
  ['{14447A2E-0D38-4249-9A22-AC452D721EDB}']
    function GetImages: TCustomImageList;
    procedure PopulateFilterImages(AValues: TcxFilterValueList);
  ...
  IdxCustomFunctionFilterableComponent = interface(IdxCustomFunctionContainer)
  ...
  strict private
    FCustomFunctionName: string;
    FDisplayText: string;
    FOperatorKind: TcxFilterOperatorKind;
    FValue: Variant;
  public
    constructor Create(AValue: Variant; ADisplayText: string;
      AOperatorKind: TcxFilterOperatorKind; const ACustomFunctionName: string = '');

    property CustomFunctionName: string read FCustomFunctionName;
  ...
  strict private
    ...
    FFilterImagesProvider: IdxFilterImagesProvider;
    FIsModified: Boolean;
    ...
    FOnAfterFilterChange: TNotifyEvent;
    FOnBeforeFilterChange: TNotifyEvent;
  ...
  protected
    ...
    procedure AfterFilterChange; virtual;
    procedure BeforeFilterChange; virtual;
    ...
    procedure PopulateImageIndexes; virtual;
    ...
    property FilterImagesProvider: IdxFilterImagesProvider read FFilterImagesProvider;
  ...
  public
    ...
    property OnAfterFilterChange: TNotifyEvent read FOnAfterFilterChange write FOnAfterFilterChange;
    property OnBeforeFilterChange: TNotifyEvent read FOnBeforeFilterChange write FOnBeforeFilterChange;
  end;
  ...
  protected
    ...
    procedure UpdateListBoxImages; virtual;
  ...
  { TdxExcelFilterValueContainerSearchEditViewInfo }

  TdxExcelFilterValueContainerSearchEditViewInfo = class(TcxCustomTextEditViewInfo)
  private
    function GetSearchButtonInfo: TcxEditButtonViewInfo;
  protected
    procedure DrawEditButton(ACanvas: TcxCanvas; AButtonVisibleIndex: Integer); override;

    property SearchButtonInfo: TcxEditButtonViewInfo read GetSearchButtonInfo;
  end;

  { TdxExcelFilterValueContainerSearchEdit }

  TdxExcelFilterValueContainerSearchEdit = class(TcxCustomButtonEdit)
  protected
    function GetViewInfoClass: TcxContainerViewInfoClass; override;
  public
    constructor Create(AOwner: TComponent); override;
  ...
  { TdxDateTimeTreeViewNode }

  TdxDateTimeTreeViewNode = class(TdxTreeViewNode)
  strict private
    FIsStateValid: Boolean;

    function GetFirst: TdxDateTimeTreeViewNode;
    function GetNext: TdxDateTimeTreeViewNode;
    function GetParent: TdxDateTimeTreeViewNode;
    function GetTreeView: TdxExcelFilterValueContainerCustomDateTimeTreeView;
  protected
    ...
    property IsStateValid: Boolean read FIsStateValid write FIsStateValid;
  public
    property First: TdxDateTimeTreeViewNode read GetFirst;
    property Next: TdxDateTimeTreeViewNode read GetNext;
    property Parent: TdxDateTimeTreeViewNode read GetParent;

    property TreeView: TdxExcelFilterValueContainerCustomDateTimeTreeView read GetTreeView;
  end;
  ...
  strict private
    ...
    FIncrementalFilteringText: string;
    FIsNodeStatesLoading: Boolean;
    FNodeStatesUpdateCount: Integer;

    function GetLastLevel: Integer;
    function GetRoot: TdxDateTimeTreeViewNode;
    procedure SetIncrementalFilteringText(const AValue: string);

    function LoadNodeStateProc(ANode: TdxTreeCustomNode; AData: Pointer): Boolean;
  protected
    procedure ApplyFilter; virtual;
    procedure CorrectCheckedIndexes(ANode: TdxDateTimeTreeViewNode); virtual;
    procedure DoPopulateNodes; virtual;
    procedure FilterValuesChanged; virtual;
    ...
    function GetLevelCount: Integer; virtual;
    function GetNodeClass: TdxTreeViewNodeClass; override;
    function HasIncrementalFiltering: Boolean; virtual;
    function IsFilterValueVisible(AFilterValue: TcxFilterValueItem; AText: string): Boolean; virtual;
    function IsTextVisible(AText: string): Boolean; virtual;
    procedure LoadNodeStates; virtual;
    procedure NodeStateChanged(ANode: TdxTreeViewNode); override;
    procedure PopulateNodes; virtual;
    procedure UpdateNodes; virtual;
    procedure UpdateNodeStateByChildState(ANode: TdxDateTimeTreeViewNode; AChildState: TcxCheckBoxState); virtual;

    function IsNodeStatesUpdating: Boolean; virtual;
    procedure BeginUpdateNodeStates; virtual;
    procedure EndUpdateNodeStates; virtual;
    ...
    property IsNodeStatesLoading: Boolean read FIsNodeStatesLoading;
  ...
  public
    ...
    property Root: TdxDateTimeTreeViewNode read GetRoot;
  end;
  ...
  { TdxExcelFilterValueContainerDateTimeTreeView }

  TdxExcelFilterValueContainerDateTimeTreeView = class(TdxExcelFilterValueContainerCustomDateTimeTreeView)
  strict private
    FHasTime: Boolean;
    FHasTimeAssigned: Boolean;

    function GetHasTime: Boolean;
  protected
    function GetValueTextByLvl(AFilterValue: TcxFilterValueItem; ALvl: Integer): string; override;
    function Use24HourFormat: Boolean; virtual;
  ...
  strict private
    FIsEditValueNumeric: Boolean;
  protected
    function IsEditValueNumeric: Boolean; override;
    procedure SetEditValueNumeric(AValue: Boolean); virtual;
  end;
  ...
  strict private
    ...
    procedure ValidateHandler(ASender: TcxCustomEdit; var ADisplayValue: TcxEditValue; var AErrorText: TCaption; var AError: Boolean); //..
  protected
    function GetFilterDisplayText: string; virtual;
    function GetFilterValue: Variant; virtual;
    function GetSourceProperties: TcxCustomEditProperties; virtual;
    function GetTextHint: string; virtual;
    ...
    procedure PopulateItem(AItem: TcxFilterValueItem); virtual;
    procedure PopulateItems; override;

    property SourceProperties: TcxCustomEditProperties read GetSourceProperties;
  public
    constructor Create(AFilterValueContainer: TdxExcelFilterValueContainer); override;

    class function GetPropertiesClass: TcxCustomEditPropertiesClass; override;

    property Properties: TdxExcelFilterValueContainerValuesComboBoxProperties read GetProperties;
  end;

  { TdxExcelFilterValueContainerDateEditProperties }

  TdxExcelFilterValueContainerDateEditProperties = class(TcxDateEditProperties)
  strict private
    FComboBoxProperties: TdxExcelFilterValueContainerDateValuesComboBoxProperties;
  protected
    function GetEmptyString: string; override;
  public
    constructor Create(AComboBoxProperties: TdxExcelFilterValueContainerDateValuesComboBoxProperties); reintroduce; virtual;
  end;

  { TdxExcelFilterValueContainerDateValuesComboBoxProperties }

  TdxExcelFilterValueContainerDateValuesComboBoxProperties = class(TdxExcelFilterValueContainerValuesComboBoxProperties)
  strict private
    FDateEditProperties: TdxExcelFilterValueContainerDateEditProperties;
  protected
    ...
    procedure InitDateEditProperties(ASourceProperties: TcxCustomEditProperties); virtual;
    procedure PrepareEditValue(ADisplayValue: string; out AEditValue: TcxEditValue); virtual;

    property DateEditProperties: TdxExcelFilterValueContainerDateEditProperties read FDateEditProperties;
  public
    ...
    procedure ValidateDisplayValue(var ADisplayValue: Variant; var AErrorText: TCaption; var AError: Boolean; AEdit: TcxCustomEdit); override;
  end;

  { TdxExcelFilterValueContainerDateValuesComboBox }

  TdxExcelFilterValueContainerDateValuesComboBox = class(TdxExcelFilterValueContainerValuesComboBox)
  strict private const
    CalendarButtonGlyphHeight = 16;
    CalendarButtonGlyphWidth = 16;
  strict private
    FCalendar: TcxCustomCalendar;
    FCalendarButton: TcxEditButton;
    FCalendarPopup: TdxUIElementPopupWindow;

    function GetProperties: TdxExcelFilterValueContainerDateValuesComboBoxProperties;
  ...
  protected
    ...
    function CreateCalendar: TcxCustomCalendar; virtual;
    function CreateCalendarPopup: TdxUIElementPopupWindow; virtual;
    function GetFilterValue: Variant; override;
    function GetSourceProperties: TcxCustomEditProperties; override;
    function GetTextHint: string; override;
    ...
    function IsEditValueNumeric: Boolean; override;
    procedure PopulateItem(AItem: TcxFilterValueItem); override;
  ...
  public
    ...
    property Properties: TdxExcelFilterValueContainerDateValuesComboBoxProperties read GetProperties;
  end;

  { TdxExcelFilterValueContainerValuesComboBoxProvider }

  TdxExcelFilterValueContainerCustomValuesComboBoxProvider = class
  strict private
    FComboBox: TcxCustomComboBox;
    FFilterValueContainer: TdxExcelFilterValueContainer;
  protected
    function CreateComboBox: TcxCustomComboBox; virtual; abstract;
    function GetComboBoxFilterDisplayText: string; virtual;
    function GetComboBoxFilterValue: Variant; virtual;
    function IsComboBoxEmpty: Boolean; virtual;
    procedure UpdateComboBoxItems; virtual;

    property ComboBox: TcxCustomComboBox read FComboBox;
    property FilterValueContainer: TdxExcelFilterValueContainer read FFilterValueContainer;
  public
  ...
  TdxExcelFilterValueContainerValuesComboBoxProvider = class(TdxExcelFilterValueContainerCustomValuesComboBoxProvider)
  strict private
    function GetComboBox: TdxExcelFilterValueContainerValuesComboBox;
  protected
    function CreateComboBox: TcxCustomComboBox; override;
    function GetComboBoxFilterDisplayText: string; override;
    function GetComboBoxFilterValue: Variant; override;
    function IsComboBoxEmpty: Boolean; override;
    procedure UpdateComboBoxItems; override;

    property ComboBox: TdxExcelFilterValueContainerValuesComboBox read GetComboBox;
  end;

  { TdxExcelFilterValueContainerDateValuesComboBoxProvider }

  TdxExcelFilterValueContainerDateValuesComboBoxProvider = class(TdxExcelFilterValueContainerValuesComboBoxProvider)
  protected
    function CreateComboBox: TcxCustomComboBox; override;
  end;

  { TdxExcelFilterValueContainerImageValuesComboBoxProvider }

  TdxExcelFilterValueContainerImageValuesComboBoxProvider = class(TdxExcelFilterValueContainerCustomValuesComboBoxProvider)
  protected
    function CreateComboBox: TcxCustomComboBox; override;
  end;
  ...
  strict private
    FOwner: TdxExcelFilterValueContainerConditionContainer;
  protected
    procedure Apply; virtual;
    function GetBoolOperator: TcxFilterBoolOperatorKind; virtual;
    function GetCustomFunctionName: string; virtual;
    ...
    property BoolOperator: TcxFilterBoolOperatorKind read GetBoolOperator;
    property CustomFunctionName: string read GetCustomFunctionName;
    property DisplayText: string read GetDisplayText;
    property &Operator: TcxFilterOperatorKind read GetOperator;
    property Owner: TdxExcelFilterValueContainerConditionContainer read FOwner;
    property Value: Variant read GetValue;
  public
    constructor Create(AFilterValueContainer: TdxExcelFilterValueContainer;
      AOwner: TdxExcelFilterValueContainerConditionContainer); reintroduce; virtual;
  end;
  ...
  strict private
    FComboBoxProvider: TdxExcelFilterValueContainerCustomValuesComboBoxProvider;
  ...
  protected
    ...
    property ComboBoxProvider: TdxExcelFilterValueContainerCustomValuesComboBoxProvider read FComboBoxProvider;
  ...
  strict private
    FFromComboBoxProvider: TdxExcelFilterValueContainerCustomValuesComboBoxProvider;
    FToComboBoxProvider: TdxExcelFilterValueContainerCustomValuesComboBoxProvider;
  protected
    procedure DoGenerate(AParentGroup: TdxLayoutGroup); override;
    ...
    property FromComboBoxProvider: TdxExcelFilterValueContainerCustomValuesComboBoxProvider read FFromComboBoxProvider;
    property ToComboBoxProvider: TdxExcelFilterValueContainerCustomValuesComboBoxProvider read FToComboBoxProvider;
  public
    destructor Destroy; override;
  end;
  ...
  { TdxExcelFilterValueContainerCustomFunctionCondition }

  TdxExcelFilterValueContainerCustomFunctionCondition = class(TdxExcelFilterValueContainerEditableCondition) // for internal use only
  private
    FCheckBox: TdxLayoutCheckBoxItem;
    FCustomFunctionName: string;
    FFunctionOperator: TdxCustomFunctionOperator;
    FTextEdits: TcxObjectList;
    FLayoutItems: TcxObjectList;
    FOwner: TdxExcelFilterValueContainerPredefinedFiltersCondition;
    function GetTextEdit(AIndex: Integer): TcxTextEdit;
    function GetTextEditCount: Integer;
  protected
    procedure CheckBoxClickHandler(Sender: TObject); virtual;
    procedure CheckTextEditStates; virtual;
    procedure DoGenerate(AParentGroup: TdxLayoutGroup); override;
    function GenerateTextEdit: TcxTextEdit; virtual;
    procedure GenerateTextEdits(AFunctionOperator: TdxCustomFunctionOperatorBrowsable); virtual;
    function GetCustomFunctionName: string; override;
    function GetDisplayText: string; override;
    function GetValue: Variant; override;
    function IsEmpty: Boolean; override;
    procedure UpdateData; override;
    ...
    property CheckBox: TdxLayoutCheckBoxItem read FCheckBox;
    property FunctionOperator: TdxCustomFunctionOperator read FFunctionOperator;
    property Owner: TdxExcelFilterValueContainerPredefinedFiltersCondition read FOwner;
    property TextEditCount: Integer read GetTextEditCount;
    property TextEdits[AIndex: Integer]: TcxTextEdit read GetTextEdit;
  public
    constructor Create(AFilterValueContainer: TdxExcelFilterValueContainer;
      AOwner: TdxExcelFilterValueContainerPredefinedFiltersCondition;
      const ACustomFunctionName: string); reintroduce; virtual;
    destructor Destroy; override;
  end;

  { TdxExcelFilterValueContainerPredefinedFiltersCondition }

  TdxExcelFilterValueContainerPredefinedFiltersCondition = class(TdxExcelFilterValueContainerEditableCondition) // for internal use only
  private
    FConditions: TdxFastObjectList;
    FGroups: TdxFastObjectList;
    function GetCondition(AIndex: Integer): TdxExcelFilterValueContainerCustomFunctionCondition;
    function GetConditionCount: Integer;
  protected
    procedure DoGenerate(AParentGroup: TdxLayoutGroup); override;
    function GetBoolOperator: TcxFilterBoolOperatorKind; override;
    function GetCustomFunctionName: string; override;
    procedure GenerateConditions; virtual;
    function GenerateCondition(const ACustomFunctionName: string): TdxExcelFilterValueContainerCustomFunctionCondition; virtual;
    function GetDisplayText: string; override;
    function GetValue: Variant; override;
    function IsComplex: Boolean; override;
    function IsEmpty: Boolean; override;
    ...
    property Conditions[AIndex: Integer]: TdxExcelFilterValueContainerCustomFunctionCondition read GetCondition;
  public
    destructor Destroy; override;
  end;
  ...
  strict private
    ...
    FConditionContainer1: TdxExcelFilterValueContainerCustomFilterConditionContainer;
    FConditionContainer2: TdxExcelFilterValueContainerCustomFilterConditionContainer;

    function GetCondition1: TdxExcelFilterValueContainerCondition;
    function GetCondition2: TdxExcelFilterValueContainerCondition;
  protected
    ...
    procedure GenerateConditionContainer1; virtual;
    procedure GenerateConditionContainer2; virtual;
    function GetBoolOperator: TcxFilterBoolOperatorKind; override;
    function GetDisplayText: string; override;
    function GetOperator: TcxFilterOperatorKind; override;
    ...
    property Condition1: TdxExcelFilterValueContainerCondition read GetCondition1;
    property Condition2: TdxExcelFilterValueContainerCondition read GetCondition2;
    property ConditionContainer1: TdxExcelFilterValueContainerCustomFilterConditionContainer read FConditionContainer1;
    property ConditionContainer2: TdxExcelFilterValueContainerCustomFilterConditionContainer read FConditionContainer2;
  public
    destructor Destroy; override;
  end;
  ...
  strict private
    ...
    FNeedUpdateConditionDataOnConditionTypeChanged: Boolean;
    FSupportedConditionTypes: TdxExcelFilterValueContainerConditionTypes;
  ...
  protected
    ...
    property NeedUpdateConditionDataOnConditionTypeChanged: Boolean read FNeedUpdateConditionDataOnConditionTypeChanged;
  ...
  strict private
    ...
    procedure FromEditChangeHandler(ASender: TObject);
    procedure FromEditValidateHandler(ASender: TcxCustomEdit; var ADisplayValue: TcxEditValue;  //..
      var AErrorText: TCaption; var AError: Boolean);
    procedure ToEditChangeHandler(ASender: TObject);
    procedure ToEditValidateHandler(ASender: TcxCustomEdit; var ADisplayValue: TcxEditValue;    //..
      var AErrorText: TCaption; var AError: Boolean);
  protected
  ...
  strict private
    ...
    FSearchEdit: TdxExcelFilterValueContainerSearchEdit;
    FSearchText: string;
  ...
  protected
    ...
    property SearchEdit: TdxExcelFilterValueContainerSearchEdit read FSearchEdit;
  ...
  protected
    ...
    function IsLargeIntNumeric: Boolean; virtual;
    function IsSimpleNumeric: Boolean; virtual;
    procedure KeyDownHandler(Sender: TObject; var Key: Word; Shift: TShiftState); override;
  ...
  { TdxExcelFilterValueContainerCustomValuesLayout }

  TdxExcelFilterValueContainerCustomValuesLayout = class(TdxExcelFilterValueContainerLayout)
  strict private
    FValuesPage: TdxExcelFilterValueContainerCustomValuesPage;
    FValuesPageGroup: TdxLayoutGroup;
  protected
    function CreateValuesPage: TdxExcelFilterValueContainerCustomValuesPage; virtual; abstract;
  ...
  { TdxExcelFilterValueContainerCustomValuesAndFiltersLayout }

  TdxExcelFilterValueContainerCustomValuesAndFiltersLayout = class(TdxExcelFilterValueContainerCustomValuesLayout)
  strict private
  ...
  TdxExcelFilterValueContainerCheckModeLayout = class(TdxExcelFilterValueContainerCustomValuesLayout)
  protected
  ...
  TdxExcelFilterValueContainerLookupModeLayout = class(TdxExcelFilterValueContainerCustomValuesLayout)
  protected
    function CreateValuesPage: TdxExcelFilterValueContainerCustomValuesPage; override;
  end;
  ...
  TdxExcelFilterValueContainerDateTreeViewModeLayout = class(TdxExcelFilterValueContainerCustomValuesAndFiltersLayout)
  protected
    function CreateValuesPage: TdxExcelFilterValueContainerCustomValuesPage; override;
  ...
  TdxExcelFilterValueContainerTimeTreeViewModeLayout = class(TdxExcelFilterValueContainerCustomValuesAndFiltersLayout)
  protected
    function CreateValuesPage: TdxExcelFilterValueContainerCustomValuesPage; override;
    function GetFiltersPageCaption: string; override;
  end;
  ...
  TdxExcelFilterValueContainerListBoxModeLayout = class(TdxExcelFilterValueContainerCustomValuesAndFiltersLayout)
  protected
    function CreateValuesPage: TdxExcelFilterValueContainerCustomValuesPage; override;
    function GetFiltersPageCaption: string; override;
  end;
  ...
  TdxExcelFilterValueContainerRangeModeLayout = class(TdxExcelFilterValueContainerCustomValuesAndFiltersLayout)
  protected
    function CreateValuesPage: TdxExcelFilterValueContainerCustomValuesPage; override;
    function GetFiltersPageCaption: string; override;
  end;
  ...
  strict private
    ...
    FCustomFunctionComponent: IdxCustomFunctionFilterableComponent;
    ...
    function GetHasCustomFunctions: Boolean;
  ...
  protected
    ...
    function IsEditValueValid(var AValue: Variant): Boolean; virtual;
    ...
    procedure LinkComponentChanged; override;
    function NeedImmediateApply: Boolean; override;
    procedure NonUniqueValuesNeeded; virtual;
    procedure PopulateNonUniqueValues; virtual;
    procedure PopulateValues; override;
    procedure SetFilterActiveCustomFunction(const ACustomFunctionName: string; const AValue: Variant; const ADisplayText: string); virtual;
    procedure SetFilterActiveValue(AOperatorKind: TcxFilterOperatorKind; const AValue: Variant; const ADisplayText: string); virtual;
    procedure SetFilterActiveValues(AValueInfos: TdxFastObjectList; ABoolOperator: TcxFilterBoolOperatorKind); virtual;
    procedure UpdateLayoutControlPosition; virtual;
    procedure UpdateValues; override;

    function CreateFilterEdit: TcxCustomEdit; virtual;
    function CreateFilterValuesComboBoxProvider: TdxExcelFilterValueContainerCustomValuesComboBoxProvider; virtual;
    function CreateLayout: TdxExcelFilterValueContainerCustomValuesLayout; virtual;
    function CreateLayoutControl: TdxLayoutControl; virtual;
    function CreateLayoutLookAndFeel: TdxLayoutCxLookAndFeel; virtual;

    property CustomFunctionComponent: IdxCustomFunctionFilterableComponent read FCustomFunctionComponent;
    property CustomFunctions: TStringList read FCustomFunctions;
    property HasCustomFunctions: Boolean read GetHasCustomFunctions;
...
uses
  System.Types, System.SysUtils, Vcl.Graphics, System.Math, System.Variants, System.DateUtils, Vcl.Menus, Vcl.StdCtrls, dxGDIPlusClasses, cxGeometry, cxDrawTextUtils, cxEditConsts,
  cxTrackBar, cxFormats, cxFilterConsts, cxVariants, System.RTLConsts, dxMessages, cxTimeEdit, cxImageComboBox,
  cxLookAndFeels;
...
type
  ...
  { TcxCustomCalendarHelper }

  TcxCustomCalendarHelper = class helper for TcxCustomCalendar
  public
  ...
  TcxDateComboBoxMaskStandardMode = class(TcxMaskEditStandardMode)
  protected
...
procedure TcxCustomCalendarHelper.DoCalculate;
begin
  Calculate;
end;

function TcxCustomCalendarHelper.GetLookAndFeel: TcxLookAndFeel;
begin
  Result := LookAndFeel;
end;

procedure TcxCustomCalendarHelper.SetColor(AColor: TColor);
begin
  Color := AColor;
end;
...
{ TcxDateComboBoxMaskStandardMode }

function TcxDateComboBoxMaskStandardMode.GetBlank(APos: Integer): Char;
begin
  Result := TdxExcelFilterValueContainerDateValuesComboBoxProperties(Properties).GetStandardMaskBlank(APos);
end;
...
begin
  inherited Create;
  FCustomFunctionName := ACustomFunctionName;
...
begin
  ...
  begin
    ...
    if IsFilterValueVisible(AFilterValueItem, ADisplayValue) then
      Items.AddObject(ADisplayValue, AFilterValueItem, AFilterValueItem.ImageIndex);
  end;
end;
...
begin
  ...
  begin
    ...
    cxTextOut(Canvas.Canvas, AText, R, CXTO_LEFT or CXTO_CENTER_VERTICALLY or CXTO_SINGLELINE or CXTO_END_ELLIPSIS,
      ASelStart, Length(IncrementalFilteringText), Canvas.Font,
...
begin
  if HasIncrementalFiltering then
    Result := FilterValueContainer.Values.IndexOf(GetFilterValue(AItemIndex))
  else
    Result := AItemIndex;
end;
...
procedure TdxCustomFilterValueContainerListBox.InternalMouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
  inherited InternalMouseDown(Button, Shift, X, Y);
  if (ItemIndex >= 0) and ItemRect(ItemIndex).Contains(X, Y) and not HitAtItemCheckBox(ItemIndex) then
    Click;
end;
...
procedure TdxCustomFilterValueContainer.AfterFilterChange;
begin
  if Assigned(FOnAfterFilterChange) then
    FOnAfterFilterChange(Self);
end;

procedure TdxCustomFilterValueContainer.BeforeFilterChange;
begin
  if Assigned(FOnBeforeFilterChange) then
    FOnBeforeFilterChange(Self);
end;
...
begin
  ...
  Supports(LinkComponent, IdxFilterImagesProvider, FFilterImagesProvider);
  UpdateFiltering;
end;
...
procedure TdxCustomFilterValueContainer.PopulateImageIndexes;
begin
  if FilterImagesProvider <> nil then
    FilterImagesProvider.PopulateFilterImages(Values);
end;
...
procedure TdxFilterValueContainer.UpdateListBoxImages;
begin
  if FilterImagesProvider <> nil then
    ListBox.Images := FilterImagesProvider.Images;
end;
...
procedure TdxExcelFilterValueContainerSearchEditViewInfo.DrawEditButton(ACanvas: TcxCanvas; AButtonVisibleIndex: Integer);
begin
  inherited DrawEditButton(ACanvas, AButtonVisibleIndex);
  if SearchButtonInfo <> ButtonsInfo[AButtonVisibleIndex] then
    Exit;
  Painter.DrawScaledSearchEditButtonGlyph(ACanvas, SearchButtonInfo.Bounds, cxbsNormal, ScaleFactor);
end;

function TdxExcelFilterValueContainerSearchEditViewInfo.GetSearchButtonInfo: TcxEditButtonViewInfo;
begin
  Result := ButtonsInfo[0];
end;

{ TdxExcelFilterValueContainerSearchEdit }

constructor TdxExcelFilterValueContainerSearchEdit.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
  Properties.Buttons[0].Kind := bkGlyph;
end;

function TdxExcelFilterValueContainerSearchEdit.GetViewInfoClass: TcxContainerViewInfoClass;
begin
  Result := TdxExcelFilterValueContainerSearchEditViewInfo;
end;

{ TdxDateTimeTreeViewNode }

function TdxDateTimeTreeViewNode.IsAll: Boolean;
begin
  Result := Self = Root.First;
end;

function TdxDateTimeTreeViewNode.IsBlank: Boolean;
begin
  Result := (Data <> nil) and (TcxFilterValueItem(Data).Kind = fviBlanks);
end;

function TdxDateTimeTreeViewNode.IsGroup: Boolean;
begin
  Result := (Level < TreeView.LastLevel) and not IsRoot and not IsAll and not IsBlank;
end;

function TdxDateTimeTreeViewNode.IsValue: Boolean;
begin
  Result := Level = TreeView.LastLevel;
end;

function TdxDateTimeTreeViewNode.GetFirst: TdxDateTimeTreeViewNode;
begin
  Result := TdxDateTimeTreeViewNode(inherited First);
end;

function TdxDateTimeTreeViewNode.GetNext: TdxDateTimeTreeViewNode;
begin
  Result := TdxDateTimeTreeViewNode(inherited Next);
end;

function TdxDateTimeTreeViewNode.GetParent: TdxDateTimeTreeViewNode;
begin
  Result := TdxDateTimeTreeViewNode(inherited Parent);
end;

function TdxDateTimeTreeViewNode.GetTreeView: TdxExcelFilterValueContainerCustomDateTimeTreeView;
begin
  Result := TdxExcelFilterValueContainerCustomDateTimeTreeView(inherited TreeView);
end;
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.CorrectCheckedIndexes(ANode: TdxDateTimeTreeViewNode);
begin
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.DoPopulateNodes;

  function GetActualNode(ALevel: Integer; AInfo: TStringList): TdxTreeViewNode;
  begin
    if ALevel = -1 then
      Result := Root
    else
      Result := TdxTreeViewNode(AInfo.Objects[ALevel]);
  end;

  procedure InitializeInfo(AInfo: TStringList);
  var
    I: Integer;
  begin
    for I := 0 to LastLevel do
      AInfo.AddObject('', nil);
  end;

  procedure ResetInfo(AInfo: TStringList; AStartWithLevel: Integer);
  var
    I: Integer;
  begin
    for I := AStartWithLevel to LastLevel do
    begin
      AInfo[I] := '';
      AInfo.Objects[I] := nil;
    end;
...
begin
  ...
  try
    InitializeInfo(AInfo);
    for I := 0 to FilterValueContainer.Values.Count - 1 do
    begin
      AFilterValue := FilterValueContainer.Values[I];
      if not IsFilterValueVisible(AFilterValue, FilterValueContainer.DisplayValues[I]) then
        Continue;
      if AFilterValue.Kind <> fviValue then
        GetActualNode(-1, AInfo).AddChild(FilterValueContainer.DisplayValues[I], AFilterValue)
      else
        for ALevel := 0 to LastLevel do
        begin
          AText := GetValueTextByLvl(AFilterValue, ALevel);
          if ALevel = LastLevel then
            GetActualNode(ALevel - 1, AInfo).AddChild(AText, AFilterValue)
          else
            if AInfo[ALevel] <> AText then
            begin
              AInfo[ALevel] := AText;
              AInfo.Objects[ALevel] := GetActualNode(ALevel - 1, AInfo).AddChild(AInfo[ALevel]);
              ResetInfo(AInfo, ALevel + 1);
            end;
        end
    end;
  finally
...
function TdxExcelFilterValueContainerCustomDateTimeTreeView.GetDefaultScrollbarsValue: TcxScrollStyle;
begin
  Result := ssVertical;
end;
...
begin
  Result := FilterValueContainer.Values.IndexOf(TcxFilterValueItem(ANode.Data))
end;
...
function TdxExcelFilterValueContainerCustomDateTimeTreeView.GetLevelCount: Integer;
begin
  Result := 3;
end;

function TdxExcelFilterValueContainerCustomDateTimeTreeView.GetNodeClass: TdxTreeViewNodeClass;
begin
  Result := TdxDateTimeTreeViewNode;
end;
...
function TdxExcelFilterValueContainerCustomDateTimeTreeView.IsFilterValueVisible(AFilterValue: TcxFilterValueItem; AText: string): Boolean;
var
  ALevel: Integer;
  ADisplayText: string;
begin
  ...
  if AFilterValue.Kind <> fviValue then
    ...
    for ALevel := 0 to LastLevel do
    begin
      ADisplayText := GetValueTextByLvl(AFilterValue, ALevel);
      if IsTextVisible(ADisplayText) then
        Exit(True);
    end;
end;
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.LoadNodeStates;
begin
  if (Root.Count = 0) or (Length(FilterValueContainer.CheckedValueIndexes) = 0) then
    Exit;
  BeginUpdate;
  FIsNodeStatesLoading := True;
  try
    dxTreeForEach(Root, LoadNodeStateProc, nil);
  finally
    FIsNodeStatesLoading := False;
    EndUpdate;
  end;
end;
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.NodeStateChanged(ANode: TdxTreeViewNode);
  ...
  procedure SetChildStates(AParent: TdxDateTimeTreeViewNode; AState: TcxCheckBoxState);
  var
    ARoot: TdxTreeViewNode;
  begin
    if AParent.IsAll then
      ARoot := Root
    else
      if AParent.IsGroup then
        ARoot := AParent
      else
        ARoot := nil;
    dxTreeForEach(ARoot,
      ...
      begin
        if (ANode <> ARoot) and (ANode <> AParent) then
          TdxTreeViewNode(ANode).CheckState := AState;
        Result := True;
      end,
      nil);
  end;

  procedure UpdateParentStates(AParent: TdxDateTimeTreeViewNode);
  var
    AChild: TdxDateTimeTreeViewNode;
  begin
    while not AParent.IsRoot do
    begin
      AParent.CheckState := cbsUnchecked;
      AParent.IsStateValid := False;
      if AParent.IsAll then
        AChild := AParent.Next
      else
        AChild := AParent.First;
      while (AChild <> nil) and (AParent.CheckState <> cbsGrayed) do
      begin
        UpdateNodeStateByChildState(AParent, AChild.CheckState);
        AChild := AChild.Next;
      end;
      if AParent.IsAll then
        AParent := Root
...
var
  AAbsolute: TdxDateTimeTreeViewNode absolute ANode;
begin
  inherited NodeStateChanged(AAbsolute);
  if FIsNodeStatesLoading then Exit;
  if AAbsolute.IsValue or AAbsolute.IsBlank then
    CorrectCheckedIndexes(AAbsolute);
  if IsNodeStatesUpdating then Exit;
  BeginUpdate;
  BeginUpdateNodeStates;
  try
    if AAbsolute.HasChildren or AAbsolute.IsAll then
      SetChildStates(AAbsolute, AAbsolute.CheckState);
    if AAbsolute.Parent.IsRoot then
      UpdateParentStates(Root.First)
    else
      UpdateParentStates(AAbsolute.Parent);
  finally
    EndUpdateNodeStates;
    EndUpdate;
  end;
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.PopulateNodes;
begin
  if FilterValueContainer.Values.Count = 0 then
    Exit;
  BeginUpdate;
  try
    DoPopulateNodes;
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.UpdateNodes;
begin
  BeginUpdate;
  try
    Root.Clear;
...
procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.UpdateNodeStateByChildState(
  ANode: TdxDateTimeTreeViewNode; AChildState: TcxCheckBoxState);
begin
  if not ANode.IsStateValid then
  begin
    ANode.CheckState := AChildState;
    ANode.IsStateValid := True;
  end
  else
    if ANode.CheckState <> AChildState then
      ANode.CheckState := cbsGrayed;
end;

function TdxExcelFilterValueContainerCustomDateTimeTreeView.IsNodeStatesUpdating: Boolean;
begin
  Result := FNodeStatesUpdateCount > 0;
end;

procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.BeginUpdateNodeStates;
begin
  Inc(FNodeStatesUpdateCount);
end;

procedure TdxExcelFilterValueContainerCustomDateTimeTreeView.EndUpdateNodeStates;
begin
  Dec(FNodeStatesUpdateCount);
end;

function TdxExcelFilterValueContainerCustomDateTimeTreeView.GetLastLevel: Integer;
begin
  Result := LevelCount - 1;
end;

function TdxExcelFilterValueContainerCustomDateTimeTreeView.GetRoot: TdxDateTimeTreeViewNode;
begin
  Result := TdxDateTimeTreeViewNode(inherited Root);
end;
...
function TdxExcelFilterValueContainerCustomDateTimeTreeView.LoadNodeStateProc(
  ANode: TdxTreeCustomNode; AData: Pointer): Boolean;

  procedure LoadNodeState(ANode: TdxDateTimeTreeViewNode);
  var
  ...
  begin
    ...
    for I := 0 to High(FilterValueContainer.CheckedValueIndexes) do
    begin
      AFilterValueIndex := FilterValueContainer.CheckedValueIndexes[I];
      ANode.Checked := ANode.Data = FilterValueContainer.Values[AFilterValueIndex];
      if ANode.Checked then
        Break;
    end;
  end;
...
var
  AParent: TdxDateTimeTreeViewNode;
  AAbsolute: TdxDateTimeTreeViewNode absolute ANode;
begin
  Result := True;
  if not (AAbsolute.IsValue or AAbsolute.IsBlank) then
    Exit;
  LoadNodeState(AAbsolute);
  AParent := AAbsolute.Parent;
  while not AParent.IsRoot do
  begin
    UpdateNodeStateByChildState(AParent, AAbsolute.CheckState);
    AParent := AParent.Parent;
  end;
  UpdateNodeStateByChildState(Root.First, AAbsolute.CheckState);
end;
...
begin
  if Safe.Cast<TcxCustomTimeEditProperties>(FilterValueContainer.FilterProperties, ATimeEditProperties) and ATimeEditProperties.Use24HourFormat then
    Result := 'hh'
  else
    Result := 'hh ampm';
end;
...
function TdxExcelFilterValueContainerDateTimeTreeView.GetValueTextByLvl(AFilterValue: TcxFilterValueItem; ALvl: Integer): string;
var
  AFormat: string;
begin
  case ALvl of
    ...
    2:
      begin
        ...
        if HasTime then
        begin
          AFormat := Format('%s %s', [AFormat, 'hh:nn:ss']);
          if not Use24HourFormat then
            AFormat := Format('%s %s', [AFormat, 'ampm']);
        end;
        Result := FormatDateTime(AFormat, AFilterValue.Value);
      end;
    3:
      begin
        AFormat := 'hh';
...
function TdxExcelFilterValueContainerDateTimeTreeView.Use24HourFormat: Boolean;
begin
  Result := Pos(dxFormatSettings.TimeAMString, dxFormatSettings.ShortTimeFormat) = 0;
end;

function TdxExcelFilterValueContainerDateTimeTreeView.GetHasTime: Boolean;
var
  I: Integer;
  AFilterValue: TcxFilterValueItem;
begin
  if not FHasTimeAssigned then
  begin
    FHasTime := False;
    for I := 0 to FilterValueContainer.Values.Count - 1 do
    begin
      AFilterValue := FilterValueContainer.Values[I];
      FHasTime := (AFilterValue.Kind = fviValue) and (AFilterValue.Value <> DateOf(AFilterValue.Value));
      if FHasTime then
        Break;
    end;
    FHasTimeAssigned := True;
  end;
  Result := FHasTime;
end;
...
begin
  Result := FIsEditValueNumeric;
end;

procedure TdxExcelFilterValueContainerValuesComboBoxProperties.SetEditValueNumeric(AValue: Boolean);
begin
  FIsEditValueNumeric := AValue;
end;
...
begin
  Result := FilterValueContainer.GetDisplayTextByValue(GetFilterValue);
end;
...
begin
  ...
  begin
    if Properties.IsMasked then
      ...
      Result := EditingValue;
    if FilterValueContainer.FilterValueTypeClass <> nil then
      VarCast(Result, Result, FilterValueContainer.FilterValueTypeClass.GetVarType);
  end;
end;

function TdxExcelFilterValueContainerValuesComboBox.GetSourceProperties: TcxCustomEditProperties;
begin
  Result := FilterValueContainer.FilterProperties;
end;

function TdxExcelFilterValueContainerValuesComboBox.GetTextHint: string;
begin
  Result := cxGetResourceString(@sdxExcelFilterSelectValueHintText);
end;

procedure TdxExcelFilterValueContainerValuesComboBox.Initialize;
begin
  inherited Initialize;
  Properties.SetEditValueNumeric(IsEditValueNumeric);
end;
...
begin
  ...
  InitPropertiesMask;
  TextHint := GetTextHint;
  Properties.DefaultValuesProvider := SourceProperties.DefaultValuesProvider;
  Properties.Alignment.Horz := taLeftJustify;
  Properties.Alignment.Vert := taVCenter;
  Properties.AutoSelect := not Properties.IsMasked;
  Properties.MRUMode := True;
...
begin
  if SourceProperties is TcxCustomTextEditProperties then
  begin
    ATextEditProperties := TcxCustomTextEditProperties(SourceProperties);
...
begin
  if SourceProperties is TcxCustomMaskEditProperties then
  begin
    AMaskEditProperties := TcxCustomMaskEditProperties(SourceProperties);
...
function TdxExcelFilterValueContainerValuesComboBox.IsEditValueNumeric: Boolean;
begin
  Result := FilterValueContainer.GetDataType = fdtNumeric;
end;
...
var
  ...
  AValue: Variant;
begin
  Result := VarIsSoftNull(EditingValue) and (ItemIndex = -1);
  if not Result then
  begin
    AText := '';
    if Properties.IsMasked then
      ...
      AValue := EditingValue;
    DoValidateDisplayValue(AValue, AText, Result);
  end;
end;

procedure TdxExcelFilterValueContainerValuesComboBox.PopulateItem(AItem: TcxFilterValueItem);
begin
  Properties.Items.AddObject(AItem.Value, AItem);
end;
...
begin
  ...
  try
    for I := AIndex to FilterValueContainer.DisplayValues.Count - 1 do
      PopulateItem(FilterValueContainer.Values[I]);
  finally
    Properties.Items.EndUpdate;
  end;
end;
...
procedure TdxExcelFilterValueContainerValuesComboBox.ValidateHandler(ASender: TcxCustomEdit;  //..
...
begin
  ...
  if Properties.IsMasked then
    ...
    AEdit.PrepareEditValue(ADisplayValue, AValue, True);
  AError := AError or not FilterValueContainer.IsEditValueValid(AValue);
  if not AError then
    AEdit.GetProperties.PrepareDisplayValue(AValue, ADisplayValue, True)
  else
    ADisplayValue := '';
end;
...
constructor TdxExcelFilterValueContainerDateEditProperties.Create(
  AComboBoxProperties: TdxExcelFilterValueContainerDateValuesComboBoxProperties);
begin
  inherited Create(nil);
  FComboBoxProperties := AComboBoxProperties;
end;

function TdxExcelFilterValueContainerDateEditProperties.GetEmptyString: string;
begin
  Result := FComboBoxProperties.GetEmptyString;
end;

{ TdxExcelFilterValueContainerDateValuesComboBoxProperties }

constructor TdxExcelFilterValueContainerDateValuesComboBoxProperties.Create(AOwner: TPersistent);
begin
  inherited Create(AOwner);
  FDateEditProperties := TdxExcelFilterValueContainerDateEditProperties.Create(Self);
end;

destructor TdxExcelFilterValueContainerDateValuesComboBoxProperties.Destroy;
begin
  FreeAndNil(FDateEditProperties);
  inherited Destroy;
end;

procedure TdxExcelFilterValueContainerDateValuesComboBoxProperties.DoPrepareDisplayValue(const AEditValue: TcxEditValue;
  var ADisplayValue: TcxEditValue; AEditFocused: Boolean);
begin
  DateEditProperties.DoPrepareDisplayValue(AEditValue, ADisplayValue, AEditFocused);
end;

procedure TdxExcelFilterValueContainerDateValuesComboBoxProperties.ValidateDisplayValue(
  var ADisplayValue: Variant; var AErrorText: TCaption; var AError: Boolean; AEdit: TcxCustomEdit);
var
  ADateEdit: TcxDateEdit;
begin
  ADateEdit := TcxDateEdit.Create(nil);
  try
    ADateEdit.Properties := DateEditProperties;
    DateEditProperties.ValidateDisplayValue(ADisplayValue, AErrorText, AError, ADateEdit);
  finally
    ADateEdit.Free;
  end;
end;

function TdxExcelFilterValueContainerDateValuesComboBoxProperties.GetModeClass(
  AMaskKind: TcxEditMaskKind): TcxMaskEditCustomModeClass;
begin
  if AMaskKind = emkStandard then
    Result := TcxDateComboBoxMaskStandardMode
  else
    Result := inherited GetModeClass(AMaskKind);
end;

function TdxExcelFilterValueContainerDateValuesComboBoxProperties.GetStandardMaskBlank(APos: Integer): Char;
begin
  Result := DateEditProperties.GetStandardMaskBlank(APos);
end;

procedure TdxExcelFilterValueContainerDateValuesComboBoxProperties.InitDateEditProperties(ASourceProperties: TcxCustomEditProperties);
begin
  DateEditProperties.Assign(ASourceProperties);
  DateEditProperties.InputKind := ikRegExpr;
  DateEditProperties.DateOnError := deNull;
  DateEditProperties.SaveTime := False;
end;

procedure TdxExcelFilterValueContainerDateValuesComboBoxProperties.PrepareEditValue(
  ADisplayValue: string; out AEditValue: TcxEditValue);
begin
  DateEditProperties.InternalPrepareEditValue(ADisplayValue, AEditValue);
end;

{ TdxExcelFilterValueContainerDateValuesComboBox }

constructor TdxExcelFilterValueContainerDateValuesComboBox.Create(AFilterValueContainer: TdxExcelFilterValueContainer);
begin
  inherited Create(AFilterValueContainer);
  AddCalendarButton;
  AddCalendar;
...
destructor TdxExcelFilterValueContainerDateValuesComboBox.Destroy;
begin
...
procedure TdxExcelFilterValueContainerDateValuesComboBox.PrepareEditValue(const ADisplayValue: TcxEditValue;
  out EditValue: TcxEditValue; AEditFocused: Boolean);
begin
  Properties.PrepareEditValue(ADisplayValue, EditValue);
end;

class function TdxExcelFilterValueContainerDateValuesComboBox.GetPropertiesClass: TcxCustomEditPropertiesClass;
begin
  Result := TdxExcelFilterValueContainerDateValuesComboBoxProperties;
end;

procedure TdxExcelFilterValueContainerDateValuesComboBox.AddCalendar;
begin
...
procedure TdxExcelFilterValueContainerDateValuesComboBox.AddCalendarButton;
begin
  FCalendarButton := Properties.Buttons.Add;
  CalendarButton.Glyph.SourceHeight := CalendarButtonGlyphHeight;
  CalendarButton.Glyph.SourceWidth := CalendarButtonGlyphWidth;
...
procedure TdxExcelFilterValueContainerDateValuesComboBox.CalendarButtonClick;
begin
  CalendarDropDown;
end;

procedure TdxExcelFilterValueContainerDateValuesComboBox.CalendarDropDown;
begin
  if ItemIndex <> -1 then
    if ItemObject <> nil then
  ...
  Calendar.SetColor(ActiveStyle.Color);
  Calendar.GetLookAndFeel.MasterLookAndFeel := ActiveStyle.LookAndFeel;
  Calendar.CalendarButtons := [btnClear];
  Calendar.DoCalculate;
...
function TdxExcelFilterValueContainerDateValuesComboBox.CreateCalendar: TcxCustomCalendar;
begin
  Result := TcxCustomCalendar.Create(nil);
end;

function TdxExcelFilterValueContainerDateValuesComboBox.CreateCalendarPopup: TdxUIElementPopupWindow;
begin
  Result := TdxUIElementPopupWindow.Create(Self);
end;

function TdxExcelFilterValueContainerDateValuesComboBox.GetFilterValue: Variant;
begin
  if ItemObject <> nil then
    Result := inherited GetFilterValue
  else
    Result := EditingValue;
end;

function TdxExcelFilterValueContainerDateValuesComboBox.GetSourceProperties: TcxCustomEditProperties;
begin
  Result := Properties.DateEditProperties;
end;

function TdxExcelFilterValueContainerDateValuesComboBox.GetTextHint: string;
begin
  Result := cxGetResourceString(@sdxExcelFilterSelectDateHintText);
end;

procedure TdxExcelFilterValueContainerDateValuesComboBox.InitProperties;
begin
  Properties.InitDateEditProperties(FilterValueContainer.FilterProperties);
  inherited InitProperties;
end;

function TdxExcelFilterValueContainerDateValuesComboBox.InternalGetEditingValue: TcxEditValue;
begin
  PrepareEditValue(Text, Result, True);
end;

procedure TdxExcelFilterValueContainerDateValuesComboBox.InternalValidateDisplayValue(const ADisplayValue: TcxEditValue);
begin
...
function TdxExcelFilterValueContainerDateValuesComboBox.IsEditValueNumeric: Boolean;
begin
  Result := True;
end;

procedure TdxExcelFilterValueContainerDateValuesComboBox.PopulateItem(AItem: TcxFilterValueItem);
var
  ADisplayValue: Variant;
begin
  Properties.PrepareDisplayValue(AItem.Value, ADisplayValue, True);
  Properties.Items.AddObject(ADisplayValue, AItem);
end;

function TdxExcelFilterValueContainerDateValuesComboBox.GetProperties: TdxExcelFilterValueContainerDateValuesComboBoxProperties;
begin
  Result := TdxExcelFilterValueContainerDateValuesComboBoxProperties(inherited Properties);
end;

procedure TdxExcelFilterValueContainerDateValuesComboBox.ButtonClickHandler(Sender: TObject; AButtonIndex: Integer);
begin
  if AButtonIndex = CalendarButton.Index then
    CalendarButtonClick;
end;

procedure TdxExcelFilterValueContainerDateValuesComboBox.DateTimeChangedHandler(Sender: TObject);
begin
...
constructor TdxExcelFilterValueContainerCustomValuesComboBoxProvider.Create(AFilterValueContainer: TdxExcelFilterValueContainer);
begin
  inherited Create;
  FFilterValueContainer := AFilterValueContainer;
...
destructor TdxExcelFilterValueContainerCustomValuesComboBoxProvider.Destroy;
begin
  FreeAndNil(FComboBox);
  inherited;
end;

function TdxExcelFilterValueContainerCustomValuesComboBoxProvider.GetComboBoxFilterDisplayText: string;
begin
  Result := ComboBox.Text;
end;

function TdxExcelFilterValueContainerCustomValuesComboBoxProvider.GetComboBoxFilterValue: Variant;
begin
  Result := ComboBox.EditingValue;
end;

function TdxExcelFilterValueContainerCustomValuesComboBoxProvider.IsComboBoxEmpty: Boolean;
begin
  Result := VarIsSoftNull(ComboBox.EditingValue) and (ComboBox.ItemIndex = -1);
end;

procedure TdxExcelFilterValueContainerCustomValuesComboBoxProvider.UpdateComboBoxItems;
begin
//do nothing
end;
...
function TdxExcelFilterValueContainerValuesComboBoxProvider.CreateComboBox: TcxCustomComboBox;
begin
  Result := TdxExcelFilterValueContainerValuesComboBox.Create(FilterValueContainer);
end;

function TdxExcelFilterValueContainerValuesComboBoxProvider.GetComboBoxFilterDisplayText: string;
begin
  Result := ComboBox.GetFilterDisplayText;
end;

function TdxExcelFilterValueContainerValuesComboBoxProvider.GetComboBoxFilterValue: Variant;
begin
  Result := ComboBox.GetFilterValue;
end;

function TdxExcelFilterValueContainerValuesComboBoxProvider.IsComboBoxEmpty: Boolean;
begin
  Result := ComboBox.IsEmpty;
end;

procedure TdxExcelFilterValueContainerValuesComboBoxProvider.UpdateComboBoxItems;
begin
  ComboBox.UpdateItems;
end;

function TdxExcelFilterValueContainerValuesComboBoxProvider.GetComboBox: TdxExcelFilterValueContainerValuesComboBox;
begin
  Result := TdxExcelFilterValueContainerValuesComboBox(inherited ComboBox);
end;

{ TdxExcelFilterValueContainerDateValuesComboBoxProvider }

function TdxExcelFilterValueContainerDateValuesComboBoxProvider.CreateComboBox: TcxCustomComboBox;
begin
  Result := TdxExcelFilterValueContainerDateValuesComboBox.Create(FilterValueContainer);
end;

{ TdxExcelFilterValueContainerImageValuesComboBoxProvider }

function TdxExcelFilterValueContainerImageValuesComboBoxProvider.CreateComboBox: TcxCustomComboBox;
begin
  Result := FilterValueContainer.CreateFilterEdit as TcxImageComboBox;
end;
...
procedure TdxExcelFilterValueContainerCondition.Apply;
var
...
begin
  if IsEmpty then
    ...
    begin
      ...
      try
        PopulateValueInfos(AValueInfos);
        FilterValueContainer.SetFilterActiveValues(AValueInfos, BoolOperator);
      finally
        AValueInfos.Free;
      end;
    end
    else
      if CustomFunctionName <> '' then
        FilterValueContainer.SetFilterActiveCustomFunction(CustomFunctionName, Value, DisplayText)
      else
        FilterValueContainer.SetFilterActiveValue(&Operator, Value, DisplayText);
end;
...
function TdxExcelFilterValueContainerCondition.GetCustomFunctionName: string;
begin
  Result := '';
end;
...
begin
  Result := dxOperatorByConditionTypeMap[Owner.GetConditionType];
end;
...
begin
  Result := Owner.IsConditionPresentInFilter;
end;
...
begin
  AInfo := TdxExcelFilterValueContainerValueInfo.Create(Value, DisplayText, &Operator, CustomFunctionName);
  AList.Add(AInfo);
end;
...
constructor TdxExcelFilterValueContainerCondition.Create(AFilterValueContainer: TdxExcelFilterValueContainer;
  AOwner: TdxExcelFilterValueContainerConditionContainer);
begin
  inherited Create(AFilterValueContainer);
  FOwner := AOwner;
end;
...
begin
  ...
  try
    TextEdit.EditValue := Owner.ActiveCriteriaItems[0].Value;
  finally
...
begin
  FComboBoxProvider := FilterValueContainer.CreateFilterValuesComboBoxProvider;
  ComboBoxProvider.ComboBox.OnKeyDown := KeyDownHandler;
  ComboBoxProvider.ComboBox.Properties.OnChange := EditChangeHandler;
  FComboBoxLayoutItem := ParentGroup.CreateItemForControl(ComboBoxProvider.ComboBox);
  ComboBoxLayoutItem.AlignHorz := ahClient;
end;

function TdxExcelFilterValueContainerComboBoxCondition.GetDisplayText: string;
begin
  Result := ComboBoxProvider.GetComboBoxFilterDisplayText;
end;

function TdxExcelFilterValueContainerComboBoxCondition.GetValue: Variant;
begin
  Result := ComboBoxProvider.GetComboBoxFilterValue;
end;

function TdxExcelFilterValueContainerComboBoxCondition.IsEmpty: Boolean;
begin
  Result := ComboBoxProvider.IsComboBoxEmpty;
end;
...
begin
  ComboBoxProvider.UpdateComboBoxItems;
  inherited UpdateData;
end;
...
begin
  inherited UpdateValues;
  ComboBoxProvider.ComboBox.LockChangeEvents(True);
  try
    ComboBoxProvider.ComboBox.EditValue := Owner.ActiveCriteriaItems[0].Value;
  finally
    ComboBoxProvider.ComboBox.LockChangeEvents(False, False);
  end;
end;
...
begin
  FreeAndNil(FToComboBoxProvider);
  FreeAndNil(FFromComboBoxProvider);
  inherited Destroy;
end;
...
begin
  FFromComboBoxProvider := FilterValueContainer.CreateFilterValuesComboBoxProvider;
  FromComboBoxProvider.ComboBox.OnKeyDown := KeyDownHandler;
  FromComboBoxProvider.ComboBox.Properties.OnChange := EditChangeHandler;
  ALayoutItem := ParentGroup.CreateItemForControl(FromComboBoxProvider.ComboBox);
  ALayoutItem.CaptionOptions.Text := cxGetResourceString(@sdxExcelFilterFromValueText);
  ALayoutItem.AlignHorz := ahClient;
end;
...
var
  ALayoutItem: TdxLayoutItem;
begin
  FToComboBoxProvider := FilterValueContainer.CreateFilterValuesComboBoxProvider;
  ToComboBoxProvider.ComboBox.OnKeyDown := KeyDownHandler;
  ToComboBoxProvider.ComboBox.Properties.OnChange := EditChangeHandler;
  ALayoutItem := ParentGroup.CreateItemForControl(ToComboBoxProvider.ComboBox);
  ALayoutItem.CaptionOptions.Text := cxGetResourceString(@sdxExcelFilterToValueText);
  ALayoutItem.AlignHorz := ahClient;
end;

function TdxExcelFilterValueContainerBetweenCondition.GetDisplayText: string;
begin
  if FromComboBoxProvider.IsComboBoxEmpty then
    Result := ToComboBoxProvider.GetComboBoxFilterDisplayText
  else
    if ToComboBoxProvider.IsComboBoxEmpty then
      Result := FromComboBoxProvider.GetComboBoxFilterDisplayText
    else
      if VarCompare(GetValueFrom, GetValueTo) < 0 then
        Result := FromComboBoxProvider.GetComboBoxFilterDisplayText + ';' + ToComboBoxProvider.GetComboBoxFilterDisplayText
      else
        Result := ToComboBoxProvider.GetComboBoxFilterDisplayText + ';' + FromComboBoxProvider.GetComboBoxFilterDisplayText;
end;
...
begin
  Result := FromComboBoxProvider.GetComboBoxFilterValue;
end;

function TdxExcelFilterValueContainerBetweenCondition.GetValueTo: Variant;
begin
  Result := ToComboBoxProvider.GetComboBoxFilterValue;
end;

function TdxExcelFilterValueContainerBetweenCondition.IsEmpty: Boolean;
begin
  Result := FromComboBoxProvider.IsComboBoxEmpty and ToComboBoxProvider.IsComboBoxEmpty;
end;

procedure TdxExcelFilterValueContainerBetweenCondition.UpdateData;
begin
  FromComboBoxProvider.UpdateComboBoxItems;
  ToComboBoxProvider.ComboBox.Properties.Items := FromComboBoxProvider.ComboBox.Properties.Items;
  inherited UpdateData;
end;
...
begin
  inherited UpdateValues;
  if Owner.ActiveCriteriaItems[0].OperatorKind = foBetween then
  begin
    AFromValue := Owner.ActiveCriteriaItems[0].Value[0];
    AToValue := Owner.ActiveCriteriaItems[0].Value[1];
  end
  else
  begin
    AFromValue := Owner.ActiveCriteriaItems[0].Value;
    AToValue := Owner.ActiveCriteriaItems[1].Value;
  end;
  FromComboBoxProvider.ComboBox.LockChangeEvents(True);
  try
    FromComboBoxProvider.ComboBox.EditValue := AFromValue;
  finally
    FromComboBoxProvider.ComboBox.LockChangeEvents(False, False);
  end;
  ToComboBoxProvider.ComboBox.LockChangeEvents(True);
  try
    ToComboBoxProvider.ComboBox.EditValue := AToValue;
  finally
    ToComboBoxProvider.ComboBox.LockChangeEvents(False, False);
  end;
end;
...
procedure TdxExcelFilterValueContainerCounterCondition.CalculateValues;
  ...
  begin
    if Owner.GetConditionType = ctTopN then
...
begin
  ...
  ALayoutItem := ParentGroup.CreateItemForControl(ValueSpinEdit);
  ALayoutItem.CaptionOptions.Text := cxGetResourceString(@sdxExcelFilterTopNBottomNValueLabel);
  ALayoutItem.AlignHorz := ahClient;
end;
...
begin
  ...
  ALayoutItem := ParentGroup.CreateItemForControl(ValueTypeComboBox);
  ALayoutItem.CaptionOptions.Text := cxGetResourceString(@sdxExcelFilterTopNBottomNTypeLabel);
  ALayoutItem.AlignHorz := ahClient;
end;
...
var
  I: Integer;
  ALayoutItem: TdxLayoutItem;
  ASeparator: TdxLayoutEmptySpaceItem;
begin
  if ParentGroup.Count > 1 then
  begin
    ASeparator := TdxLayoutEmptySpaceItem(Group.CreateItem(TdxLayoutEmptySpaceItem));
    ASeparator.SizeOptions.Height := 4;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if ACheckBox.Checked then
      begin
        AInfo := TdxExcelFilterValueContainerValueInfo.Create(Value, DisplayText, TcxFilterOperatorKind(ACheckBox.Tag));
        AList.Add(AInfo);
      end;
    end;
  end;
...
begin
  inherited UpdateValues;
  AOperators := [];
  for I := 0 to Owner.ActiveCriteriaItems.Count - 1 do
    Include(AOperators, Owner.ActiveCriteriaItems[I].OperatorKind);
...
constructor TdxExcelFilterValueContainerCustomFunctionCondition.Create(AFilterValueContainer: TdxExcelFilterValueContainer;
  AOwner: TdxExcelFilterValueContainerPredefinedFiltersCondition; const ACustomFunctionName: string);
begin
  inherited Create(AFilterValueContainer, AOwner.Owner);
  FOwner := AOwner;
  FCustomFunctionName := ACustomFunctionName;
  FFunctionOperator := TdxCustomFunctionOperatorFactory.GetCustomFunctionOperator(CustomFunctionName);
end;

destructor TdxExcelFilterValueContainerCustomFunctionCondition.Destroy;
begin
...
procedure TdxExcelFilterValueContainerCustomFunctionCondition.CheckBoxClickHandler(Sender: TObject);
begin
  CheckTextEditStates;
  ValueChanged;
end;

procedure TdxExcelFilterValueContainerCustomFunctionCondition.CheckTextEditStates;
var
  I: Integer;
begin
  for I := 0 to TextEditCount - 1 do
    TextEdits[I].Enabled := CheckBox.Checked;
end;

procedure TdxExcelFilterValueContainerCustomFunctionCondition.DoGenerate(AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  FCheckBox := TdxLayoutCheckBoxItem(AParentGroup.CreateItem(TdxLayoutCheckBoxItem));
  CheckBox.CaptionOptions.Text := TdxCustomFunctionOperatorFactory.GetCustomFunctionOperatorName(FunctionOperator);
  CheckBox.OnClick := CheckBoxClickHandler;
  if FunctionOperator is TdxCustomFunctionOperatorBrowsable then
    GenerateTextEdits(TdxCustomFunctionOperatorBrowsable(FunctionOperator));
end;

function TdxExcelFilterValueContainerCustomFunctionCondition.GenerateTextEdit: TcxTextEdit;
var
  ALayoutItem: TdxLayoutItem;
begin
  Result := TcxTextEdit.Create(nil);
  Result.Style.TransparentBorder := False;
  Result.TextHint := cxGetResourceString(@sdxExcelFilterEnterValueHintText);
  Result.OnKeyDown := KeyDownHandler;
  Result.Enabled := False;
  Result.Properties.OnChange := EditChangeHandler;
  FTextEdits.Add(Result);
  ALayoutItem := ParentGroup.CreateItemForControl(Result);
  ALayoutItem.AlignHorz := ahClient;
  ALayoutItem.Padding.Left := 16;
  ALayoutItem.Enabled := False;
  FLayoutItems.Add(ALayoutItem);
end;

procedure TdxExcelFilterValueContainerCustomFunctionCondition.GenerateTextEdits(
  AFunctionOperator: TdxCustomFunctionOperatorBrowsable);
var
  I: Integer;
begin
  if AFunctionOperator.MinOperandCount > 1 then
  begin
    FTextEdits := TcxObjectList.Create;
    FLayoutItems := TcxObjectList.Create;
    for I := 1 to AFunctionOperator.MaxOperandCount - 1 do
      GenerateTextEdit;
  end;
end;

function TdxExcelFilterValueContainerCustomFunctionCondition.GetCustomFunctionName: string;
begin
  Result := FCustomFunctionName;
end;

function TdxExcelFilterValueContainerCustomFunctionCondition.GetDisplayText: string;
var
  I: Integer;
begin
  if TextEditCount > 0 then
  begin
    Result := TextEdits[0].Text;
    for I := 1 to TextEditCount - 1 do
      Result := Result + ';' + TextEdits[I].Text;
  end
  else
    Result := inherited GetDisplayText;
end;

function TdxExcelFilterValueContainerCustomFunctionCondition.GetValue: Variant;
var
  I: Integer;
begin
  case TextEditCount of
    0:
    ...
    begin
      Result := VarListArrayCreate(TextEdits[0].Text);
      for I := 1 to TextEditCount - 1 do
        VarListArrayAddValue(Result, TextEdits[I].Text);
    end;
  end;
end;

function TdxExcelFilterValueContainerCustomFunctionCondition.IsEmpty: Boolean;
var
  I: Integer;
begin
  Result := not CheckBox.Checked;
  if not Result and (TextEditCount > 0) then
  begin
    Result := True;
    for I := 0 to TextEditCount - 1 do
      if TextEdits[I].Text <> '' then
      begin
        Result := False;
        Break;
      end;
...
procedure TdxExcelFilterValueContainerCustomFunctionCondition.UpdateData;
var
  I: Integer;
begin
  inherited UpdateData;
  for I := 0  to FilterValueContainer.Filter.Root.Count - 1 do
    if (FilterValueContainer.Filter.Root.Items[I] is TcxFilterCriteriaItem) then
      if TcxFilterCriteriaItem(FilterValueContainer.Filter.Root.Items[I]).CustomFunctionName = CustomFunctionName then
      begin
...
procedure TdxExcelFilterValueContainerCustomFunctionCondition.ValueChanged;
begin
  Owner.ValueChanged;
end;

function TdxExcelFilterValueContainerCustomFunctionCondition.GetTextEdit(AIndex: Integer): TcxTextEdit;
begin
  Result := TcxTextEdit(FTextEdits[AIndex]);
end;

function TdxExcelFilterValueContainerCustomFunctionCondition.GetTextEditCount: Integer;
begin
  if FTextEdits <> nil then
    Result := FTextEdits.Count
  else
    Result := 0;
end;
...
destructor TdxExcelFilterValueContainerPredefinedFiltersCondition.Destroy;
begin
...
procedure TdxExcelFilterValueContainerPredefinedFiltersCondition.DoGenerate(AParentGroup: TdxLayoutGroup);
begin
  inherited DoGenerate(AParentGroup);
  GenerateConditions;
end;

function TdxExcelFilterValueContainerPredefinedFiltersCondition.GetBoolOperator: TcxFilterBoolOperatorKind;
begin
  Result := fboOr;
end;

function TdxExcelFilterValueContainerPredefinedFiltersCondition.GetCustomFunctionName: string;
begin
  Result := Conditions[0].CustomFunctionName;
end;

procedure TdxExcelFilterValueContainerPredefinedFiltersCondition.GenerateConditions;
var
  I: Integer;
begin
  FConditions := TdxFastObjectList.Create;
  FGroups := TdxFastObjectList.Create;
  for I := 0 to FilterValueContainer.CustomFunctions.Count - 1 do
    GenerateCondition(FilterValueContainer.CustomFunctions[I]);
end;

function TdxExcelFilterValueContainerPredefinedFiltersCondition.GenerateCondition(
  const ACustomFunctionName: string): TdxExcelFilterValueContainerCustomFunctionCondition;
var
  AGroup: TdxLayoutGroup;
begin
  Result := TdxExcelFilterValueContainerCustomFunctionCondition.Create(FilterValueContainer, Self, ACustomFunctionName);
  AGroup := ParentGroup.CreateGroup;
  AGroup.ShowBorder := False;
  FGroups.Add(AGroup);
  Result.Generate(AGroup);
  FConditions.Add(Result);
end;

function TdxExcelFilterValueContainerPredefinedFiltersCondition.GetDisplayText: string;
begin
  Result := Conditions[0].DisplayText;
end;

function TdxExcelFilterValueContainerPredefinedFiltersCondition.GetValue: Variant;
begin
  Result := Conditions[0].Value;
end;

function TdxExcelFilterValueContainerPredefinedFiltersCondition.IsComplex: Boolean;
begin
  Result := ConditionCount > 1;
end;

function TdxExcelFilterValueContainerPredefinedFiltersCondition.IsEmpty: Boolean;
var
  I: Integer;
begin
  Result := True;
  for I := 0 to ConditionCount - 1 do
    if not Conditions[I].IsEmpty then
    begin
      Result := False;
      Break;
    end;
...
procedure TdxExcelFilterValueContainerPredefinedFiltersCondition.PopulateValueInfos(AList: TdxFastObjectList);
var
  I: Integer;
begin
  for I := 0 to ConditionCount - 1 do
    if not Conditions[I].IsEmpty then
      Conditions[I].PopulateValueInfos(AList);
end;

procedure TdxExcelFilterValueContainerPredefinedFiltersCondition.UpdateData;
var
  I: Integer;
begin
  inherited UpdateData;
  for I := 0 to ConditionCount - 1 do
    Conditions[I].UpdateData;
end;

function TdxExcelFilterValueContainerPredefinedFiltersCondition.GetCondition(AIndex: Integer): TdxExcelFilterValueContainerCustomFunctionCondition;
begin
  Result := TdxExcelFilterValueContainerCustomFunctionCondition(FConditions[AIndex]);
end;

function TdxExcelFilterValueContainerPredefinedFiltersCondition.GetConditionCount: Integer;
begin
...
begin
  ...
  ALayoutItem := ParentGroup.CreateItemForControl(AndRadioButton);
  ALayoutItem.CaptionOptions.Text := ' ';
end;
...
begin
  ...
  ALayoutItem := ParentGroup.CreateItemForControl(OrRadioButton);
  ALayoutItem.CaptionOptions.Visible := False;
end;
...
begin
  FreeAndNil(FConditionContainer2);
  FreeAndNil(FAndOr);
  FreeAndNil(FAndOrGroup);
  FreeAndNil(FConditionContainer1);
  inherited Destroy;
end;
...
begin
  inherited DoGenerate(AParentGroup);
  GenerateConditionContainer1;
  GenerateAndOr;
  GenerateConditionContainer2;
end;
...
procedure TdxExcelFilterValueContainerCustomFilterCondition.GenerateConditionContainer1;
begin
  FConditionContainer1 := CreateConditionContainer;
  ConditionContainer1.Generate(ParentGroup);
end;

procedure TdxExcelFilterValueContainerCustomFilterCondition.GenerateConditionContainer2;
begin
  FConditionContainer2 := CreateConditionContainer;
  ConditionContainer2.Generate(ParentGroup);
end;
...
begin
  if not Condition1.IsEmpty then
    Result := Condition1.DisplayText
  else
    if not Condition2.IsEmpty then
      Result := Condition2.DisplayText
    else
      Result := inherited GetDisplayText;
end;
...
begin
  case FilterValueContainer.GetDataType of
    fdtText:
      Result := [ctEquals..ctIsNotBlank, ctGreaterThan..ctLessEqualThanOrEqualTo];
    fdtNumeric:
...
begin
  if not Condition1.IsEmpty then
    Result := Condition1.Value
  else
    if not Condition2.IsEmpty then
      Result := Condition2.Value
    else
      Result := inherited GetValue;
end;
...
begin
  Result := not Condition1.IsEmpty and not Condition2.IsEmpty;
end;

function TdxExcelFilterValueContainerCustomFilterCondition.IsEmpty: Boolean;
begin
  Result := Condition1.IsEmpty and Condition2.IsEmpty;
end;
...
begin
  if Owner.ActiveCriteriaItems.Count = 2 then
    if AContainer = ConditionContainer1 then
      ACriteriaItem := Owner.ActiveCriteriaItems[0]
    else
      ACriteriaItem := Owner.ActiveCriteriaItems[1]
  else
    if AContainer = ConditionContainer1 then
      ACriteriaItem := Owner.ActiveCriteriaItems[0]
    else
...
begin
  Condition1.PopulateValueInfos(AList);
  Condition2.PopulateValueInfos(AList);
end;
...
begin
  inherited UpdateData;
  ConditionContainer1.SupportedConditionTypes := GetSupportedConditionTypes;
  ConditionContainer2.SupportedConditionTypes := GetSupportedConditionTypes;
  ConditionContainer1.UpdateData;
  ConditionContainer2.UpdateData;
  ConditionContainer1.SetCaption(cxGetResourceString(@sdxExcelFilterCustomFilterFirstConditionLabel));
  ConditionContainer2.SetCaption(cxGetResourceString(@sdxExcelFilterCustomFilterSecondConditionLabel));
end;
...
begin
  ...
  try
    AndOr.OrRadioButton.Checked := Owner.ActiveBoolOperator = fboOr;
    AndOr.AndRadioButton.Checked := Owner.ActiveBoolOperator = fboAnd;
  finally
    SetAndOrClickHandler(AndOrClickHandler);
  end;
end;

function TdxExcelFilterValueContainerCustomFilterCondition.GetCondition1: TdxExcelFilterValueContainerCondition;
begin
  Result := ConditionContainer1.Condition;
end;

function TdxExcelFilterValueContainerCustomFilterCondition.GetCondition2: TdxExcelFilterValueContainerCondition;
begin
  Result := ConditionContainer2.Condition;
end;
...
begin
  ...
  FNeedUpdateConditionDataOnConditionTypeChanged := True;
end;
...
var
  AType: TdxExcelFilterValueContainerConditionType;
  AHasActiveCondition: Boolean;
  AConditionTypeItemIndex: Integer;
begin
  AType := GetActiveConditionType(AHasActiveCondition);
  if AHasActiveCondition then
  begin
    AConditionTypeItemIndex := GetConditionTypeItemIndex(AType);
    if AConditionTypeItemIndex < 0 then
      AConditionTypeItemIndex := GetDefaultConditionTypeIndex;
    ConditionTypeComboBox.ItemIndex := AConditionTypeItemIndex;
  end
  else
...
begin
  ...
  UpdateActiveCriteriaItems;
  FNeedUpdateConditionDataOnConditionTypeChanged := False;
  try
    UpdateConditionType;
  finally
    FNeedUpdateConditionDataOnConditionTypeChanged := True;
...
begin
  RegenerateCondition;
  UpdateConditionCaption;
  if NeedUpdateConditionDataOnConditionTypeChanged then
    Condition.UpdateData;
...
begin
  CustomFilterCondition.Owner.ApplyFilter;
end;
...
begin
  Result := FilterValueContainer.CreateFilterEdit;
end;
...
begin
  ...
  FromEdit.Style.TransparentBorder := False;
  FromEdit.OnKeyDown := KeyDownHandler;
  FromEdit.GetProperties.ValidationOptions := [evoAllowLoseFocus];
  FromEdit.GetProperties.OnChange := FromEditChangeHandler;
  FromEdit.GetProperties.OnValidate := FromEditValidateHandler;
  ALayoutItem := ParentGroup.CreateItemForControl(FromEdit);
  ALayoutItem.CaptionOptions.Text := cxGetResourceString(@sdxExcelFilterFromValueText);
  ALayoutItem.AlignHorz := ahClient;
end;
...
begin
  FToEdit := CreateEdit;
  ToEdit.Style.TransparentBorder := False;
  ToEdit.OnKeyDown := KeyDownHandler;
  ToEdit.GetProperties.ValidationOptions := [evoAllowLoseFocus];
  ToEdit.GetProperties.OnChange := ToEditChangeHandler;
  ToEdit.GetProperties.OnValidate := ToEditValidateHandler;
  ALayoutItem := ParentGroup.CreateItemForControl(ToEdit);
  ALayoutItem.CaptionOptions.Text := cxGetResourceString(@sdxExcelFilterToValueText);
  ALayoutItem.AlignHorz := ahClient;
end;
...
begin
  inherited UpdateData;
  FFromValue := Owner.FromValue;
  FToValue := Owner.ToValue;
  UpdateEditValue(FromEdit, FromValue);
  UpdateEditValue(ToEdit, ToValue);
end;
...
begin
  Owner.SetValues(FromValue, ToValue);
  Owner.UpdateRangeTrackBar;
end;

procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.FromEditChangeHandler(ASender: TObject);
var
  AError: Boolean;
  AErrorText: TCaption;
  ADisplayValue: Variant;
begin
  if not FromEdit.EditModified then
    Exit;
  AError := False;
  AErrorText := '';
  ADisplayValue := FromEdit.GetDisplayValue;
  FromEdit.GetProperties.ValidateDisplayValue(ADisplayValue, AErrorText, AError, FromEdit);
  if not AError then
  begin
    if FilterValueContainer.FilterValueTypeClass <> nil then
      VarCast(FFromValue, FromEdit.EditingValue, FilterValueContainer.FilterValueTypeClass.GetVarType)
    else
      FFromValue := FromEdit.EditingValue;
    ValueChanged;
  end;
end;

procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.FromEditValidateHandler(ASender: TcxCustomEdit; //..
  var ADisplayValue: TcxEditValue; var AErrorText: TCaption; var AError: Boolean);
var
  AValue: Variant;
begin
  FromEdit.PrepareEditValue(ADisplayValue, AValue, True);
  AError := AError or not FilterValueContainer.IsEditValueValid(AValue);
  if AError then
    AValue := Owner.MinValue
  else
    if VarCompare(AValue, Owner.ToValue) > 0 then
    begin
      AValue := Owner.ToValue;
      AError := True;
    end;
  FromEdit.GetProperties.PrepareDisplayValue(AValue, ADisplayValue, True);
end;

procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.ToEditChangeHandler(ASender: TObject);
var
  AError: Boolean;
  AErrorText: TCaption;
  ADisplayValue: Variant;
begin
  if not ToEdit.EditModified then
    Exit;
  AError := False;
  AErrorText := '';
  ADisplayValue := ToEdit.GetDisplayValue;
  ToEdit.GetProperties.ValidateDisplayValue(ADisplayValue, AErrorText, AError, ToEdit);
  if not AError then
  begin
    if FilterValueContainer.FilterValueTypeClass <> nil then
      VarCast(FToValue, ToEdit.EditingValue, FilterValueContainer.FilterValueTypeClass.GetVarType)
    else
      FToValue := ToEdit.EditingValue;
    ValueChanged;
  end;
end;

procedure TdxExcelFilterValueContainerRangeModeValuesPageBetween.ToEditValidateHandler(ASender: TcxCustomEdit;  //..
  var ADisplayValue: TcxEditValue; var AErrorText: TCaption; var AError: Boolean);
var
  AValue: Variant;
begin
  ToEdit.PrepareEditValue(ADisplayValue, AValue, True);
  AError := AError or not FilterValueContainer.IsEditValueValid(AValue) or (VarCompare(AValue, Owner.FromValue) < 0);
  if AError then
    AValue := Owner.FromValue;
  ToEdit.GetProperties.PrepareDisplayValue(AValue, ADisplayValue, True);
end;
...
var
  ALayoutItem: TdxLayoutItem;
begin
  FSearchEdit := TdxExcelFilterValueContainerSearchEdit.Create(nil);
  ...
  ALayoutItem := ParentGroup.CreateItemForControl(SearchEdit);
  ALayoutItem.AlignHorz := ahClient;
  ALayoutItem.Padding.Bottom := -3;
end;
...
begin
  ...
  ALayoutItem := ParentGroup.CreateItemForControl(ListBox);
  ALayoutItem.AlignHorz := ahClient;
  ALayoutItem.AlignVert := avClient;
end;
...
begin
  ...
  ListBox.UpdateItems;
  ListBox.UpdateItemStates;
  if FilterValueContainer.FilterImagesProvider <> nil then
    ListBox.Images := FilterValueContainer.FilterImagesProvider.Images;
end;
...
begin
  ...
  ALayoutItem := ParentGroup.CreateItemForControl(TreeView);
  ALayoutItem.AlignHorz := ahClient;
  ALayoutItem.AlignVert := avClient;
end;
...
begin
  ...
  TreeView.UpdateNodes;
  TreeView.LoadNodeStates;
end;
...
begin
  Result := TdxExcelFilterValueContainerDateTimeTreeView.Create(FilterValueContainer);
end;
...
begin
  ...
  try
    ...
    AValueInfos.Add(AInfo);
    FilterValueContainer.SetFilterActiveValues(AValueInfos, fboAnd);
  finally
    AValueInfos.Free;
  end;
  FilterValueContainer.IsModified := False;
...
begin
  ...
  ALayoutItem := ParentGroup.CreateItemForControl(RangeTrackBar);
  ALayoutItem.AlignHorz := ahClient;
end;
...
function TdxExcelFilterValueContainerRangeModeValuesPage.IsLargeIntNumeric: Boolean;
begin
  Result := (FilterValueContainer.FilterValueTypeClass <> nil) and
    (FilterValueContainer.FilterValueTypeClass.GetVarType = varInt64);
end;

function TdxExcelFilterValueContainerRangeModeValuesPage.IsSimpleNumeric: Boolean;
begin
  Result := (FilterValueContainer.FilterValueTypeClass <> nil) and
    (FilterValueContainer.FilterValueTypeClass.GetVarType in
  ...
  if IsSimpleNumeric then
    ...
    if (AValue = GetRangeTrackBarMax) or (GetRangeTrackBarMax = GetRangeTrackBarMin) then
      ...
      begin
        ...
        if IsLargeIntNumeric then
          ADigit := 0
        else
          ADigit := dxRangeTrackBarValueDigit;
        Result := RoundTo(AMapValue, ADigit);
      end;
end;
...
begin
  ...
  if VarIsNull(FromValue) then
    FFromValue := MinValue;
  if VarIsNull(ToValue) then
    FToValue := MaxValue;
end;
...
begin
  ...
  try
    RangeTrackBar.Properties.BeginUpdate;
    try
      ...
      RangeTrackBar.Properties.EndUpdate;
    end;
  finally
...
begin
  case FilterValueContainer.GetDataType of
    fdtText:
      Result := [ctEquals..ctIsNotBlank, ctGreaterThan..ctLessEqualThanOrEqualTo, ctCustomFilter];
    fdtNumeric:
...
procedure TdxExcelFilterValueContainerCustomValuesLayout.DestroyPageGroups;
begin
  FreeAndNil(FValuesPageGroup);
  inherited DestroyPageGroups;
end;

procedure TdxExcelFilterValueContainerCustomValuesLayout.DestroyPages;
begin
  FreeAndNil(FValuesPage);
  inherited DestroyPages;
end;

procedure TdxExcelFilterValueContainerCustomValuesLayout.GeneratePageGroups;
begin
  inherited GeneratePageGroups;
  GenerateValuesPageGroup;
end;

procedure TdxExcelFilterValueContainerCustomValuesLayout.GeneratePages;
begin
  inherited GeneratePages;
  GenerateValuesPage;
end;

procedure TdxExcelFilterValueContainerCustomValuesLayout.GenerateValuesPage;
begin
  FValuesPage := CreateValuesPage;
  ValuesPage.Generate(ValuesPageGroup);
end;

procedure TdxExcelFilterValueContainerCustomValuesLayout.GenerateValuesPageGroup;
begin
...
function TdxExcelFilterValueContainerCustomValuesLayout.GetActivePage: TdxExcelFilterValueContainerCustomPage;
begin
...
function TdxExcelFilterValueContainerCustomValuesLayout.GetDefaultPageIndex: Integer;
begin
  Result := ValuesPageGroup.Index;
end;

function TdxExcelFilterValueContainerCustomValuesLayout.GetValuesPageCaption: string;
begin
...
function TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.CreateFiltersPage: TdxExcelFilterValueContainerFiltersPage;
begin
  Result := TdxExcelFilterValueContainerFiltersPage.Create(FilterValueContainer);
end;

procedure TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.DestroyPageGroups;
begin
  FreeAndNil(FFiltersPageGroup);
  inherited DestroyPageGroups;
end;

procedure TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.DestroyPages;
begin
  FreeAndNil(FFiltersPage);
  inherited DestroyPages;
end;

procedure TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.GenerateFiltersPage;
begin
  FFiltersPage := CreateFiltersPage;
  FiltersPage.Generate(FiltersPageGroup);
end;

procedure TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.GenerateFiltersPageGroup;
begin
...
procedure TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.GeneratePages;
begin
  inherited GeneratePages;
  GenerateFiltersPage;
end;

procedure TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.GeneratePageGroups;
begin
  inherited GeneratePageGroups;
  GenerateFiltersPageGroup;
end;

function TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.GetActivePage: TdxExcelFilterValueContainerCustomPage;
begin
...
function TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.GetDefaultPageIndex: Integer;
begin
...
function TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.GetFiltersPageCaption: string;
begin
  Result := '';
end;

procedure TdxExcelFilterValueContainerCustomValuesAndFiltersLayout.TabChanged;
begin
...
begin
  ...
  begin
    ...
    if CustomFunctionComponent <> nil then
    begin
      FCustomFunctions := TStringList.Create;
      CustomFunctionComponent.GetCustomFunctions(CustomFunctions);
    end;
...
function TdxExcelFilterValueContainer.IsEditValueValid(var AValue: Variant): Boolean;
begin
  Result := not VarIsNull(AValue) and ((FilterValueTypeClass = nil) or FilterHelper.IsValueValid(FilterValueTypeClass, AValue));
end;
...
procedure TdxExcelFilterValueContainer.LinkComponentChanged;
begin
  Supports(LinkComponent, IdxCustomFunctionFilterableComponent, FCustomFunctionComponent);
  inherited LinkComponentChanged;
end;
...
procedure TdxExcelFilterValueContainer.SetFilterActiveCustomFunction(const ACustomFunctionName: string;
  const AValue: Variant; const ADisplayText: string);
begin
  BeforeFilterChange;
  try
    CustomFunctionComponent.SetFilterActiveCustomFunction(ACustomFunctionName, AValue, ADisplayText);
  finally
    AfterFilterChange;
  end;
end;

procedure TdxExcelFilterValueContainer.SetFilterActiveValue(AOperatorKind: TcxFilterOperatorKind;
  const AValue: Variant; const ADisplayText: string);
begin
  BeforeFilterChange;
  try
    FilterableComponent.SetFilterActiveValue(AOperatorKind, AValue, ADisplayText);
  finally
    AfterFilterChange;
  end;
end;

procedure TdxExcelFilterValueContainer.SetFilterActiveValues(AValueInfos: TdxFastObjectList;
  ABoolOperator: TcxFilterBoolOperatorKind);
begin
  BeforeFilterChange;
  try
    FilterableComponent.SetFilterActiveValues(AValueInfos, ABoolOperator);
  finally
    AfterFilterChange;
  end;
end;
...
function TdxExcelFilterValueContainer.CreateFilterEdit: TcxCustomEdit;
begin
  Result := FilterHelper.GetFilterEdit(FilterProperties);
end;

function TdxExcelFilterValueContainer.CreateFilterValuesComboBoxProvider: TdxExcelFilterValueContainerCustomValuesComboBoxProvider;
begin
  if GetDataType = fdtDate then
    Result := TdxExcelFilterValueContainerDateValuesComboBoxProvider.Create(Self)
  else
    if FilterProperties is TcxCustomImageComboBoxProperties then
      Result := TdxExcelFilterValueContainerImageValuesComboBoxProvider.Create(Self)
    else
      Result := TdxExcelFilterValueContainerValuesComboBoxProvider.Create(Self);
end;

function TdxExcelFilterValueContainer.CreateLayout: TdxExcelFilterValueContainerCustomValuesLayout;
begin
  case GetType of
    ctRange:
...
function TdxExcelFilterValueContainer.GetHasCustomFunctions: Boolean;
begin
  Result := (FCustomFunctions <> nil) and (FCustomFunctions.Count > 0);
end;
