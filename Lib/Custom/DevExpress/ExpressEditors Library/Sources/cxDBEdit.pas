...
uses
  System.Variants, Winapi.Windows, Winapi.Messages, System.Classes, Vcl.Controls, Data.DB, Vcl.DBCtrls, System.SysUtils,
  dxCore, dxCoreClasses, cxClasses, cxContainer,
  cxCustomData, cxDataUtils, cxDB,
  cxEdit, cxBlobEdit, cxButtonEdit, cxCalc, cxCalendar, cxCheckBox, cxCurrencyEdit, cxIntegerEdit, //..
  cxDropDownEdit, cxHyperLinkEdit, cxImage, cxImageComboBox, cxListBox, cxMaskEdit,
  cxMemo, cxMRUEdit, cxRadioGroup, cxSpinEdit, cxTextEdit, cxTimeEdit, cxDurationEdit; //..
...
type
  ...
  public
    ...
    property DataLink: TcxEditFieldDataLink read FDataLink; // for internal use
  ...
  published
    ...
    property OnSetDataSource : TNotifyEvent read FOnSetDataSource write FOnSetDataSource;  //..
  end;
  ...
  TcxDBDurationEdit = class(TcxCustomDurationEdit)  //..
  private
  ...
  published
    ...
    property ParentShowHint;
    property PopupMenu;
    property Properties: TcxDurationEditProperties read GetProperties
      write SetProperties;
    property ShowHint;
    property Style;
    property StyleDisabled;
  ...
  TcxDBIntegerEdit = class(TcxCustomIntegerEdit)
  private
...
//..  Estas constantes modificables las he creado para que los campos numéricos tengan un tamaño máximo por defecto
...
begin
  ...
  case AEvent of
    deDataSetChange:
       begin
        if not (deUpdateRecord in FReceivedEvents) and (deUpdateState in FReceivedEvents) then 
...
begin
  Result := DefaultValuesProvider.DefaultCanModify;
  if not Result then
    Exit;
...
begin
  Result := inherited DefaultValuesProvider as TcxCustomDBEditDefaultValuesProvider;
end;
...
procedure TcxDBEditDataBinding.DoOnSetDataSource; //..
begin
     If   Assigned( FOnSetDataSource )
     then FOnsetDataSource( Self );
end;
...
function TcxDBTextEdit.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
function TcxDBMemo.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
function TcxDBMaskEdit.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
function TcxDBButtonEdit.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
function TcxDBCheckBox.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
function TcxDBComboBox.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
function TcxDBPopupEdit.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
function TcxDBSpinEdit.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
function TcxDBTimeEdit.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
class function TcxDBDurationEdit.GetPropertiesClass: TcxCustomEditPropertiesClass;
begin
  Result := TcxDurationEditProperties;
end;

class function TcxDBDurationEdit.GetDataBindingClass: TcxEditDataBindingClass;
begin
  Result := TcxDBTextEditDataBinding;
end;

function TcxDBDurationEdit.GetActiveProperties: TcxDurationEditProperties;
begin
  Result := TcxDurationEditProperties(InternalGetActiveProperties);
end;

function TcxDBDurationEdit.GetDataBinding: TcxDBTextEditDataBinding;
begin
  Result := TcxDBTextEditDataBinding(FDataBinding);
end;

function TcxDBDurationEdit.GetProperties: TcxDurationEditProperties;
begin
  Result := TcxDurationEditProperties(FProperties);
end;

procedure TcxDBDurationEdit.SetDataBinding(Value: TcxDBTextEditDataBinding);
begin
  FDataBinding.Assign(Value);
end;

procedure TcxDBDurationEdit.SetProperties(Value: TcxDurationEditProperties);
begin
  FProperties.Assign(Value);
end;

procedure TcxDBDurationEdit.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := LRESULT(GetcxDBEditDataLink(Self));
end;
...
function TcxDBDateEdit.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
class function TcxDBIntegerEdit.GetPropertiesClass: TcxCustomEditPropertiesClass;
begin
  Result := TcxIntegerEditProperties;
end;

class function TcxDBIntegerEdit.GetDataBindingClass: TcxEditDataBindingClass;
begin
  Result := TcxDBTextEditDataBinding;
end;

function TcxDBIntegerEdit.GetActiveProperties: TcxIntegerEditProperties;
begin
  Result := TcxIntegerEditProperties(InternalGetActiveProperties);
end;

function TcxDBIntegerEdit.GetDataBinding: TcxDBTextEditDataBinding;
begin
  Result := TcxDBTextEditDataBinding(FDataBinding);
end;

function TcxDBIntegerEdit.GetProperties: TcxIntegerEditProperties;
begin
  Result := TcxIntegerEditProperties(FProperties);
end;

procedure TcxDBIntegerEdit.SetDataBinding(Value: TcxDBTextEditDataBinding);
begin
  FDataBinding.Assign(Value);
end;

procedure TcxDBIntegerEdit.SetProperties(Value: TcxIntegerEditProperties);
begin
  FProperties.Assign(Value);
end;

procedure TcxDBIntegerEdit.CMGetDataLink(var Message: TMessage);
begin
  Message.Result := LRESULT(GetcxDBEditDataLink(Self));
end;
...
function TcxDBImageComboBox.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
...
function TcxDBRadioGroup.SupportsUIAutomation: Boolean;
begin
  Result := True;
end;
