...
uses
  System.Variants, Winapi.Windows, System.Classes, Vcl.Graphics, System.SysUtils, cxContainer;

resourcestring
  scxSEditRepositoryColorComboBoxItem = 'ColorComboBox|Defines a combo box designed for color selection';
  scxSEditRepositoryColorEditItem = 'ColorEdit|Defines an editor with a drop-down color gallery';
  scxSEditRepositoryFontNameComboBoxItem = 'FontNameComboBox|Defines a combo box for font typeface selection';
  scxSEditRepositoryLabelItem = 'Label|Defines a label';
  scxSEditRepositoryProgressBarItem = 'ProgressBar|Defines an advanced progress bar control';
  scxSEditRepositoryTrackBarItem = 'TrackBar|Defines an editor with a slider for value selection';
  scxSEditRepositoryRangeTrackBarItem = 'RangeTrackBar|Defines an editor with two sliders for value range selection';
  scxSEditRepositorySpinButtonItem = 'SpinButton|Defines a spin button';
  scxSEditRepositoryCheckComboBox = 'CheckComboBox|Defines a combo box with a drop-down check list';
  scxSEditRepositoryShellComboBoxItem = 'ShellComboBox|Defines a combo box with a drop-down shell tree view';
  scxSEditRepositoryCheckGroupItem = 'CheckGroup|Defines an editor with a set of check boxes';
  scxSEditRepositoryRatingControlItem = 'RatingControl|Defines a rating control';
  ...
  scxSEditRepositoryRichEditItem = 'RichEdit|Defines a multi-line rich text editor';

  cxSEditRichEditUndoCaption                 = '&Deshacer';
  cxSEditRichEditRedoCaption                 = '&Rehacer';
  cxSEditRichEditCutCaption                  = 'Co&rtar';
  cxSEditRichEditCopyCaption                 = '&Copiar';
  cxSEditRichEditPasteCaption                = '&Pegar';
  cxSEditRichEditDeleteCaption               = '&Borrar';
...
const
  dxThisUnitName = 'cxExtEditConsts';
