...
// Version  : 1.0
// (01/10/2024 12:50:50 - - $Rev: 112483 $)
// ************************************************************************ //
...
type
  ...
  ErrorDetalleType2 = Int64;        { "https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd"[GblSmpl] }
...
procedure RegistroDuplicadoType.SetCodigoErrorRegistro(Index: Integer; const AErrorDetalleType2: ErrorDetalleType2);
begin
...
procedure Cabecera.SetRepresentante(Index: Integer; const APersonaFisicaJuridicaESType: PersonaFisicaJuridicaESType);
begin
  FRepresentante := APersonaFisicaJuridicaESType;
  FRepresentante_Specified := True;
end;

function Cabecera.Representante_Specified(Index: Integer): boolean;
begin
...
initialization
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(ErrorDetalleType2), 'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SuministroInformacion.xsd', 'ErrorDetalleType2', 'ErrorDetalleType');
