                ...
                <li class="item product product-item">
                    <div class="product-item-info"
                        ...
                        <div class="product details product-item-details">
                            ...
                            <div id="productlist_sku"><?php echo $_product->getResource()->getAttribute('sku')->getFrontend()->getValue($_product); ?></div>
                                ...
                                <div class="product actions product-item-actions">
                                    <div class="actions-primary">
                                        <?php if ($_product->isSaleable()): ?>
                                            ...
                                            <form id="product-addtocart-form-<?= $_product->getId() ?>"
                                                ...
                                                <button type="submit"
                                                        ...
                                                        id="product-addtocart-button-<?= $_product->getId() ?>"
                                                        <?= $_product->getTypeId()=='configurable' ? 'disabled' : '' ?> >
